export default {
  ...
  global: {
    ...
    disclaimer_beta:
      "Wenn du Probleme bei der Anmeldung hast, lass es uns bitte wissen!",
    unknown: "Unbekannt",
    sectionStatus: {
    ...
    accessibility: {
      ...
      linkHint:
        "Wenn du dieses Element aktivierst, wirst du zum Browser des Geräts weitergeleitet",
      alert: "Hinweis",
      activityIndicator: {
        label: "Wird geladen",
    ...
    genericError:
      "Es liegt ein vorübergehendes Problem vor, bitte versuche es erneut.",
    ...
    jserror: {
      ...
      message:
        "Wir haben dies unserem Team gemeldet! Bitte schließe die App und starte diese erneut!"
    },
    markdown: {
    ...
    search: {
      ...
      noResultsFound:
        "Es gibt keine Ergebnisse für diese Suche: versuche etwas anderes.",
      noResultsTitle: "Keine Ergebnisse"
    }
  },
  tablet: {
    message:
      "Die Benutzeroberfläche von IO ist für Smartphones optimiert, aber alle mit deinem Gerät kompatiblen Funktionen sind weiterhin verfügbar."
  },
  rooted: {
    title:
      "Es sieht so aus, als ob die Sicherheit deines Geräts kompromittiert ist!",
  ...
  permissionRationale: {
    storage: {
      ...
      message:
        "Du kannst Gutscheine und Zertifikate speichern und Screenshots und Zahlungsmitteilungen hochladen."
    },
    camera: {
    ...
    calendar: {
      ...
      message:
        "Du kannst Fälligkeiten in deinem Kalender eintragen und eine Benachrichtigung einstellen."
    },
    torch: {
      title: "Zugriff auf die Kamera gewähren",
      message:
        "Wir brauchen Zugang zur Kamera, um die Taschenlampenfunktion zu benutzen."
    }
  },
  startup: {
    ...
    userDeletePendingAlert: {
      ...
      message:
        "Wenn du deine Meinung geändert hast, kannst du deine Anfrage im Abschnitt Datenschutz in den Einstellungen löschen.",
    ...
    slowdowns_results_screen: {
      ...
      subtitle:
        "Dies kann von unseren Systemen oder von der Verbindung deines Geräts abhängen. Bitte versuche es in ein paar Minuten erneut."
    },
  ...
  login: {
    expiration_info:
      "Aus Sicherheitsgründen musst du dich alle 30 Tage mit SPID oder CIE anmelden.",
    expiration_info_FL:
      "Aus Sicherheitsgründen musst du dich einmal im Jahr mit SPID oder CIE anmelden.",
    biometric_info:
      "Um dich anzumelden, gib einfach den Entsperrcode ein oder verwende, falls aktiviert, deinen Fingerabdruck oder dein Gesicht."
  },
  inbox: {
    enableButton: "Posteingang aktivieren",
    disableButton: "Posteingang deaktivieren",
    enableCallToActionDescription:
      "Aktiviere den Posteingang, um Mitteilungen anzusehen"
  },
  settings: {
    informativeBanner: {
      content:
        "Suchst du dein Profil? Wir haben es verschoben, es befindet sich jetzt in der oberen rechten Ecke!",
  ...
  profile: {
    fiscalCode: {
      ...
      description:
        "Verwende den Strichcode, um deine Steuernummer mitzuteilen, wenn du dazu aufgefordert wirst.",
      facSimile: "Faksimile",
    ...
    logout: {
      ...
      alertMessage:
        "Wenn du dich das nächste Mal anmeldest, musst du dich erneut mit CIE oder SPID authentifizieren.",
    ...
    main: {
      ...
      privacy: {
        ...
        subtitle:
          "Hier findest du Informationen über deine Rechte und Pflichten sowie über die Verarbeitung personenbezogener Daten.",
        loading: "Warte ein paar Sekunden, wir überprüfen dein Profil...",
        errorMessage:
          "Wir können den Status deiner Anfrage nicht abrufen. Bitte versuche es erneut.",
        removeAccount: {
          ...
          alert: {
            ...
            activeBonusDescription:
              "Es scheint, dass du einigen Initiativen auf IO beigetreten bist. Wenn du dein Profil löschst, werden die Initiativen, denen du beigetreten bist, nicht beendet.\n\nUm sie zu verwalten, geh zum Abschnitt 'Konto', andernfalls wähle 'Löschen'.",
            oldRequest:
              "Du hast bereits beantragt, dass dein Profil gelöscht wird",
            oldRequestSubtitle:
          ...
          info: {
            title: "Dein Profil löschen",
            description:
              "Du kannst jederzeit von deinem Recht Gebrauch machen, dein IO-Profil zu löschen.",
            banner:
              "Dein Profil wird innerhalb von 30 Tagen nach deinem Antrag endgültig gelöscht.",
            body: {
              ...
              p2: {
                firstPart:
                  "Alle Boni oder Rabatte, die du über die IO-App erhalten hast, ",
        ...
        exportData: {
          ...
          subtitle:
            "Du kannst die wichtigsten Daten deines IO-Profils jederzeit herunterladen.",
          description:
            "Du erhältst eine Kopie der mit deinem IO-Profil verbundenen Daten",
          detail: {
            bulletList: {
              title: "Deine Daten sind:",
              item1: "deine Steuernummer;",
              item2:
                "die von dir angegebene E-Mail-Adresse und ggf. eine Bestätigung ihrer Validierung;",
              item3: "den Text der Mitteilungen, die du erhalten hast;",
              item4: "deine Benachrichtigungseinstellungen."
            },
            paragraph1:
              "Die Informationen werden im YAML-Format heruntergeladen, einem Standardformat, das in der Datenverarbeitung den Austausch von Daten zwischen verschiedenen Anwendungen ermöglicht.",
            paragraph2: {
          ...
          alert: {
            ...
            confirmSubtitle:
              "Nach der Bearbeitung erhältst du eine E-Mail mit allen Informationen, die mit deinem Profil verbunden sind."
          },
          error:
            "Bei der Anfrage zum Datenexport ist ein Fehler aufgetreten, bitte versuche es erneut!"
        },
        privacyPolicy: {
          title: "Datenschutz und Nutzungsbedingungen",
          description:
            "Sieh die Datenschutzbestimmungen und Nutzungsbedingungen der IO-App an",
          header:
            "Informationen über die Verarbeitung persönlicher Daten der Nutzer der IO-App",
          updated:
            "Wir haben unsere Datenschutzbestimmungen und unsere Nutzungsbedingungen aktualisiert.",
          infobox:
            "Es ist notwendig, die Datenschutzbestimmungen und die Nutzungsbedingungen zu lesen und zu akzeptieren",
          contextualHelpTitlePolicy:
            "Informationen über die Datenschutzbestimmungen und die Nutzungsbedingungen des Dienstes",
        ...
        shareData: {
          ...
          listItem: {
            ...
            description:
              "Unterstütze das IO-Team bei der Überwachung der Funktionsweise der App"
          },
          screen: {
            title: "Deine Daten auf IO",
            description:
              "Wenn du deine Daten weitergibst, hilfst du uns, dein IO-Erlebnis zu verbessern und dir gezielte Unterstützung zu bieten.",
            why: {
              description: {
                one: "Wir verwenden ",
                two: "nur die Daten, die notwendig sind, ",
                three:
                  "um das Funktionieren der App zu überwachen und die angebotenen Dienste zu verbessern."
              },
            ...
            profileSettings:
              "Du kannst deine Wahl jederzeit unter Einstellungen > Datenschutz und Nutzungsbedingungen ändern",
            cta: {
      ...
      appInfo: {
        ...
        subtitle:
          "Hier findest du weitere Einzelheiten über die IO-App und erfahre mehr über ihre Einsatzmöglichkeiten.",
    ...
    data: {
      title: "Deine Daten",
      subtitle:
        "Hier findest du deine anagrafischen Daten und Kontaktdaten, die von IO verwendet werden",
      list: {
    ...
    preferences: {
      title: "Einstellungen",
      subtitle:
        "Mit diesen Einstellungen kannst du dein IO-Erlebnis individuell gestalten.",
      ...
      list: {
        ...
        preferred_language: {
          ...
          alert: {
            ...
            subtitle:
              "Du musst die App neu starten, um die Änderung zu übernehmen"
          },
          toast: {
            success: {
      ...
      notifications: {
        ...
        subtitle:
          "Wähle, ob du eine Vorschau anzeigen und Erinnerungen erhalten möchtest.",
        titleExistingUser: "Benachrichtigungen anpassen",
        subtitleExistingUser:
          "Jetzt kannst du sofort sehen, wer dir geschrieben hat oder dich an wichtige Nachrichten erinnern lassen.",
        reminders: {
          title: "Erinnerungen zulassen",
          description:
            "Auf Antrag der Körperschaft erhältst du Push-Benachrichtigungen kurz vor Fälligkeit oder wenn du die Nachrichten noch nicht gelesen hast"
        },
        preview: {
          title: "Vorschau anzeigen",
          description:
            "Absender und Betreff in die Push-Benachrichtigung einfügen · ",
  ...
  navigation: {
    ...
    accessibilityWithBadge:
      "Abschnitt {{section}}, {{unread}} neue Elemente, Panel, {{order}} von 4",
    selected: "Ausgewählt ist"
  },
  cie: {
    title: "Karte berühren",
    layCardMessageHeader:
      "Halte deine elektronische Identitätskarte für einige Sekunden auf die Rückseite deines Telefons.",
    layCardMessageFooter:
      "Wenn du nicht genau weißt, wo sich der NFC-Sensor befindet, halte deine Karte an verschiedene Stellen und warte ein paar Sekunden, bis du einen Ton hörst.",
  ...
  spid: {
    ...
    selectDemoIdp:
      "Wenn du noch keine eigene SPID-Identität hast, verwende die App im Demo-Modus",
    loginErrorAlert: {
    ...
    pending_login: {
      ...
      details:
        "Wenn du die Sitzung im Browser geöffnet hast, fahre von dort aus fort. Andernfalls gehe zurück und starte eine neue Anmeldung!",
  ...
  authentication: {
    landing: {
      ...
      cie_unsupported: {
        ...
        button: "Verstanden",
        nfc_problem:
          "Zum Lesen der CIE ist ein Gerät mit NFC-Chip erforderlich.",
        os_problem:
          "Ein Betriebssystem mit Android 6.0 oder iOS 13 oder höher ist erforderlich.",
        nfc_alert: "Dein Gerät verfügt nicht über NFC.",
        os_alert:
          "Das Betriebssystem des Geräts ist nicht auf dem neuesten Stand."
      },
      cie_bottom_sheet: {
      ...
      spid_or_cie:
        "Um IO nutzen zu können, musst du über eine dieser digitalen Werkzeuge verfügen, die deine Identität in sicherer Weise bestätigen.",
      ...
      loginSpidCieContent:
        "Ab heute kannst du dich zusätzlich zu SPID mit deiner elektronischen Identitätskarte (CIE) anmelden",
      ...
      expiredCardContent:
        "Die verwendete Karte ist möglicherweise abgelaufen oder nicht mehr gültig. Versuche dich mit SPID bei der App anzumelden.",
    ...
    wizards: {
      cie_id_wizard: {
        ...
        description:
          "Wenn du die CieID-App auf deinem Gerät hast, melde dich bei IO an, indem du die Anmeldedaten der App eingibst. Du kannst auch dein Gesicht oder deinen Fingerabdruck oder den Code, den du für die CieID-App eingerichtet hast, verwenden.",
        actions: {
          primary: {
      ...
      cie_pin_wizard: {
        ...
        description:
          "Wenn du deine elektronischen Identitätskarte zur Hand hast, kannst du dich bei IO anmelden, indem du die PIN der Karte eingibst und sie in die Nähe des Geräts hältst, damit die Daten gelesen werden können.",
        actions: {
          primary: {
      ...
      spid_wizard: {
        title: "Hast du SPID?",
        description:
          "Wenn du einen SPID hast, kannst du dich bei IO anmelden, indem du deine Anmeldedaten eingibst, dein Gesicht oder deinen Fingerabdruck verwendest oder über die App deines SPID-Anbieters.",
        actions: {
          primary: {
      ...
      id_activation_wizard: {
        ...
        description:
          "Du musst einen aktiven SPID oder eine CIE (elektronische Identitätskarte) haben, um IO nutzen zu können.",
        list_items: {
    ...
    auth_errors: {
      error_19: {
        ...
        subtitle:
          "Du hast zu oft einen falschen Benutzernamen oder ein falsches Passwort eingegeben. Bitte überprüfe deine Anmeldedaten und versuche es in ein paar Minuten noch einmal, oder wende dich an deinen SPID-Identitätsanbieter, um deine Anmeldedaten zu ändern."
      },
      error_20: {
        title: "Es war nicht möglich dich anzumelden",
        subtitle:
          "Aus Sicherheitsgründen musst du eine Identität mit einer höheren Sicherheitsstufe verwenden. Weitere Informationen erhältst du von deinem SPID-Identitätsanbieter."
      },
      error_21: {
        title: "Es ist zu viel Zeit vergangen",
        subtitle:
          "Es ist zu viel Zeit vergangen, seit du mit dem Anmelden begonnen hast: Fang noch einmal von vorne an."
      },
      error_22: {
      ...
      error_23: {
        ...
        subtitle:
          "Deine SPID-Identität wurde gesperrt oder widerrufen. Für weitere Informationen wende dich bitte an deinen SPID-Identitätsanbieter."
      },
      error_25: {
        title: "Du hast den Vorgang abgebrochen",
        subtitle:
          "Um einzusteigen, versuche es einfach noch einmal, wann immer du willst."
      },
      error_1001: {
      ...
      missing_saml_response: {
        title: "Es war nicht möglich, dich anzumelden",
        subtitle:
          "Es ist derzeit nicht möglich, dich mit deinem SPID-Identitätsanbieter anzumelden. Bitte versuche es in ein paar Minuten erneut."
      },
      generic: {
        title: "Es war nicht möglich dich anzumelden",
        subtitle:
          "Beim Anmelden ist ein Problem aufgetreten. Bitte versuche es in ein paar Minuten erneut."
      }
    },
    cie_id: {
      error_screen: {
        ...
        cie_pin_supported: {
          description:
            "Wenn du deine elektronische Identitätskarte zur Hand hast, verwende sie für den Zugang zu IO.\n\nGib die CIE-PIN ein und halte sie in die Nähe des Geräts, damit die Daten gelesen werden können.",
          primary_action_label: "Mit CIE + PIN anmelden"
        },
        cie_pin_not_supported: {
          description:
            "Wenn du einen SPID hast, melde dich bei IO an, indem du deine Anmeldedaten eingibst, dein Gesicht oder deinen Fingerabdruck verwendest oder über die App deines SPID-Anbieters.",
      ...
      cie_not_installed: {
        ...
        description:
          "Um darauf zugreifen zu können, musst du die App auf deinem Gerät installiert haben.",
    ...
    cie: {
      ...
      nfc: {
        apduNotSupported:
          "Das Betriebssystem unterstützt das Lesen der elektronischen Identitätskarte nicht. Versuche, SPID zu verwenden, um dich in der App anzumelden.",
        retry: "Erneut versuchen",
        noNfcConnectionTitle: "Hast du die Karte berührt?",
        title: "Aktiviere NFC um fortzufahren",
        subtitle:
          "Um IO das Lesen deiner CIE zu erlauben, aktiviere NFC in den Einstellungen deines Geräts.",
      ...
      pin: {
        ...
        pinCardContent:
          "Der PIN-Code besteht aus 8 Ziffern. Vier Ziffern wurden dir beim Meldeamt ausgehändigt und weitere vier Ziffern wurden dir mit der Karte nach Hause geschickt. Setze diese in dieser Reihenfolge zusammen und trage sie bitte hier ein.",
        ...
        incorrectCiePinContent1:
          "Du hast noch 2 Versuche übrig, überprüfe und versuche es erneut.",
        incorrectCiePinContent2:
          "Nach dem dritten falschen Versuch wird die PIN gesperrt. Um sie zu entsperren und eine neue einzustellen, musst du den PUK-Code in der CieID-App eingeben.",
        incorrectCiePinSecondaryActionLabel2: "Hast du deine PIN vergessen?",
        lockedCiePinContent:
          "Die PIN deiner CIE wurde gesperrt. Um sie zu entsperren und eine neue einzustellen, musst du den PUK-Code in der CieID-App eingeben.",
      ...
      card: {
        ...
        layCardMessageHeader:
          "Wenn die Karte nicht gelesen wird, halte sie an eine andere Stelle und warte ein paar Sekunden, bis du eine Vibration spürst.",
        layCardMessageHeaderiOS:
          "Wenn die Karte nicht gelesen wird, halte sie an eine andere Stelle und warte einige Sekunden.",
        layCardMessageFooter:
          "Wenn du nicht genau weißt, wo sich der NFC-Sensor befindet, halte die Karte an verschiedene Stellen und warte ein paar Sekunden, bis du eine Vibration spürst.",
        cieCardValid: "Lesen abgeschlossen!",
        readerCardTitle: "Halte sie einige Sekunden lang still.",
        readerCardHeader:
          "Wir lesen die Daten deiner Identitätskarte ein und überprüfen deren Gültigkeit.",
        readerCardFooter:
          "Halte die Karte noch ein paar Sekunden in dieser Position",
        iosAlert: {
          readingInstructions:
            "Halte deine elektronische Identitätskarte oben auf das Telefon.",
          moreTags:
            "Es wurden mehrere Karten identifiziert. Bitte lege eine Karte nach der anderen an.",
          readingInProgress:
            "WIRD GELESEN \nHalte die Karte einige Sekunden lang still...",
          readingSuccess: "Lesen abgeschlossen!",
          invalidCard:
            "Die verwendete Karte scheint keine elektronische Identitätskarte (CIE) zu sein.",
        ...
        error: {
          ...
          tryAgain:
            "Bei der Verifizierung deiner Karte ist ein Fehler aufgetreten. Es handelt sich wahrscheinlich um einen temporäres Problem, bitte versuche es erneut!",
          generic:
            "Bei der Verifizierung deiner Karte ist ein Fehler aufgetreten. Wenn du das Problem nicht lösen kannst, teile uns dies bitte über das Symbol '?' in der oberen rechten Ecke mit. Danke!",
          unknownCardTitle: "Unbekannte Karte",
          unknownCardContent:
            "Die verwendete Karte scheint keine elektronische Identitätskarte zu sein.",
          unknownCardHelpLink: "Was ist eine elektronische Identitätskarte?",
          genericErrorTitle:
            "Wir konnten die Daten nicht von der Karte abrufen",
          genericErrorSubtitle:
            "Wenn das Problem mehrmals auftritt, warte ein paar Minuten und versuche es erneut."
        }
      }
    },
    spid: "SPID",
    ...
    opt_in: {
      ...
      contextualHelpContent:
        "Hier findest du Informationen darüber, wie du dich bei IO authentifizieren kannst, sowie einige Sicherheitstipps.",
      news: "Neu",
      title: "Ab sofort kannst du leichter auf IO zugreifen",
      identity_check:
        "Du musst dich nicht mehr alle 30 Tage mit SPID oder CIE identifizieren, sondern nur noch einmal im Jahr oder wenn du die App verlässt",
      security_suggests: "Einige Sicherheitstipps",
      passcode:
        "In allen anderen Fällen reicht dein Gesicht, dein Fingerabdruck oder dein Entsperrcode aus.",
      notification:
        "Du erhältst bei jedem neuen Zugang eine E-Mail. Wenn du diese nicht erkennst, kannst dz den Zugang zu IO sperren.",
      button_accept_lv: "Ja, Schnellzugriff einrichten",
      button_decline_lv: "Melde dich alle 30 Tage mit SPID oder CIE an"
    },
    security_suggestions: {
      fingerprint:
        "Gib deinen biometrischen Erkennungs- oder Entsperrcode nicht an Dritte weiter.",
      io_logout: "Wenn du dieses Gerät verlierst, beende IO über die Website",
      io_lock_access:
        "Wenn du glaubst, dass deine SPID- oder CIE-Anmeldedaten kompromittiert wurden, blockiere den Zugriff auf IO über die Website",
      access_new_device:
        "Wenn du mit einem fremden Gerät auf IO zugreifst, denk daran, dich bei der App abzumelden.",
    ...
    idp_login: {
      ...
      recoverDescription:
        "Wenn du dein Passwort vergessen hast, tippe bitte auf die Schaltfläche unten.",
      dualRecoverDescription:
        "Wenn du deine Anmeldedaten vergessen hast, tippe bitte auf die unten stehenden Schaltflächen.",
    ...
    unlock: {
      ...
      subtitlel2:
        "Um die App nutzen zu können, müsst du zunächst den Zugang zu IO entsperren.",
      subtitlel3:
        "Um mit all deinen SPID-Anmeldedaten oder deiner CIE auf die App zugreifen zu können, musst du den Zugang entsperren.",
    ...
    unlockmodal: {
      title: "Was bedeutet das?",
      description1_1:
        "Wenn du den Zugang zu IO aus Sicherheitsgründen gesperrt hast, musst du ihn zunächst entsperren, um die App wieder öffnen zu können.",
      description1_2:
        "Alternativ kannst du die App auch über ein Login mit der",
      description1_3: "höchsten Sicherheitsstufe öffnen.",
      description1_4:
        "Diese Art der Authentifizierung erfordert einen Benutzernamen, ein Passwort und ein physisches Medium, wie z.B. eine CIE.",
      title2: "Möchtest du den Zugang zu IO entsperren?",
      listitem1:
        "Stell sicher, dass du deine digitale Identität abgesichert hast, indem du deine Anmeldedaten bei deinem Identitätsanbieter änderst.",
      listitem2_1:
        "Greif über das Internet auf IO zu, indem du deine SPID-Anmeldedaten oder deine CIE verwendest.",
      listitem2_2: "Geh zur Website",
      listitem3_1: "Geh zum Abschnitt",
      listitem3_2: "IO-Zugang entsperren",
      listitem3_3:
        "und folge den angegebenen Schritten. Wenn du dazu aufgefordert wirst, gib den",
  ...
  email: {
    cduScreens: {
      validateMail: {
        ...
        subtitle:
          "Um die App weiter nutzen zu können, musst du deine E-Mail-Adresse bestätigen:",
      ...
      emailAlreadyTaken: {
        ...
        subtitleEnd:
          "wird bereits auf IO verwendet, du musst eine andere eingeben, um die App weiter nutzen zu können.",
    ...
    read: {
      ...
      alert:
        "Achtung: dein pagoPA Konto ist mit deiner E-Mail-Adresse verknüpft. Wenn du sie änderst, wird IO deine registrierten Zahlungsmethoden und Transaktionen nicht mehr auflisten.",
    ...
    insert: {
      ...
      alertDescription:
        "Dies kann der Fall sein, wenn du mit einem Familienmitglied die gleiche Adresse teilst",
    ...
    newinsert: {
      ...
      subtitle:
        "Sie wird verwendet, um dir Mitteilungen wie Zahlungsbestätigungen oder Support-Nachrichten zu senden.",
      label: "Persönliche E-Mail Adresse",
      alert: {
        ...
        modaldescription:
          "Dies kann der Fall sein, wenn du dieselbe Adresse wie ein Familienmitglied hast",
    ...
    edit: {
      ...
      upsert_ok:
        "Die Anfrage zur Änderung der E-Mail-Adresse wurde erfolgreich übermittelt",
      upsert_ko:
        "Fehler bei der Anfrage zur Änderung der E-Mail-Adresse, versuche es erneut"
    },
    validate: {
      title: "Erinnere dich, deine E-Mail-Adresse zu bestätigen!",
      header: "E-Mail-Bestätigung",
      content1:
        "Wir haben eine E-Mail an <b>{{E-Mail}}</b> mit einem Link zur Bestätigung gesendet: tippe einfach auf diesen Link.<br/>Solange deine E-Mail-Adresse nicht bestätigt ist, werden einige Funktionen der App (Zahlungen, Nachrichtenweiterleitung per E-Mail usw.) nicht nutzbar sein, aber du kannst einige andere Funktionen trotzdem nutzen (z. B. Dienste, Nachrichten usw.)",
      content2:
        "Für einige Funktionen von IO musst du deine E-Mail-Adresse bestätigen. <br/> Wir haben eine E-Mail an <b>{{email}}</b> gesendet: Öffne deine E-Mails und tippe auf den Link.",
      cta: "Sende eine neue E-Mail zur Bestätigung",
      sent: "E-Mail gesendet",
      send_validation_ok: "E-Mail zur Bestätigung gesendet",
      send_validation_ko:
        "Beim Senden der E-Mail ist ein Fehler aufgetreten. Versuche es erneut.",
      ...
      validation_ok:
        "Deine E-Mail-Adresse wurde bestätigt. Du kannst nun alle Funktionen von IO benutzen.",
      validated: "E-Mail bestätigt!",
      validated_ok:
        "Danke, jetzt kannst du alle Zahlungsfunktionen, Nachrichtenweiterleitung usw. nutzen."
    },
    newvalidate: {
      title: "Wir haben dir eine E-Mail gesendet",
      subtitle:
        "Um deine E-Mail-Adresse zu bestätigen, folge den Anweisungen der E-Mail an",
  ...
  onboarding: {
    ...
    tos: {
      ...
      accept: "Akzeptieren",
      error:
        "Wir konnten die Datenschutzrichtlinie und die Allgemeinen Geschäftsbedingungen nicht abrufen",
      alert: {
        title: "Achtung",
        message:
          "Bitte lies den vollständigen Inhalt der Nutzungsbedingungen und der Datenschutzbestimmungen um fortzufahren"
      }
    },
    unlockCode: {
    ...
    pin: {
      ...
      subTitle:
        "Dies ist der 6-stellige Code für den Zugriff auf IO und die Autorisierung bestimmter Vorgänge in der App.",
      ...
      errors: {
        invalid: {
          title: "Zu einfach!",
          description:
            "Wähle einen Code, der schwer zu erraten ist und weder eine einzelne, sich wiederholende Zahl (z. B. 000000) noch eine Liste von geordneten Zahlen (z. B. 123456 oder 654321) enthält.",
      ...
      policy: {
        ...
        description:
          "Der Entsperrcode besteht aus 6 Ziffern und du benötigst ihn, um auf IO zuzugreifen und bestimmte Vorgänge in der App zu autorisieren.",
        bulletListTitle:
          "Wähle einen Code, der schwer zu erraten ist und nicht folgenden Inhalt hat:",
    ...
    alert: {
      ...
      description:
        "Du musst dich erneut anmelden, um die App wieder zu verwenden"
    },
    exitAlert: {
      title: "Möchtest du dich von IO abmelden?",
      description:
        "Du musst dich erneut mit SPID oder CIE anmelden um die App zu benutzen."
    },
    biometric: {
      headerTitle: "IO einrichten",
      available: {
        ...
        settings:
          "Du kannst deine Wahl jederzeit unter Einstellungen > Sicherheit ändern",
        body: {
          ...
          infoStart:
            "Du kannst die biometrische Erkennung anstelle des Entsperrcodes verwenden. Sie ermöglicht dir den Zugriff auf die App und die Bestätigung von Transaktionen und Zahlungen",
          biometricType: "mit deinem Gesicht oder Fingerabdruck",
          infoEnd: "auf schnellere und sicherere Weise.",
          enrolledText:
            "Die biometrischen Daten werden im Speicher deines Telefons gespeichert und werden in keiner Weise an IO-Systeme weitergegeben oder von anderen Parteien gespeichert.",
          notEnrolled: {
      ...
      unavailable: {
        ...
        subtitle:
          "IO sendet dir Mitteilungen, die dich persönlich betreffen. Stelle sicher, dass nur du auf die App zugreifen kannst, indem du einen Code oder ein Zeichen zum Entsperren des Geräts festlegst.",
        body: {
          label: "Wie geht's?",
          step1: {
            label: "Schritt 1",
    ...
    notifications: {
      ...
      preview: {
        ...
        reminderOnPreviewOnMessage:
          "Öffne die App und bezahle die Zahlungsmitteilung von ACI",
        reminderOffPreviewOnTitle: "Gemeinde Ipazia",
        reminderOffPreviewOnMessage:
          "Die Einschreibungen für die Sommerbetreuung sind offen",
    ...
    infoConsent: {
      headerTitle: "IO einrichten",
      title:
        "Aktiviere Push-Benachrichtigungen, um keine wichtigen Nachrichten zu verpassen!",
      subTitle:
        "Dazu musst du die Einstellungen in den Systemeinstellungen deines Geräts ändern.",
  ...
  payment: {
    alertNoPaymentMethods: {
      ...
      message:
        "Die Zahlungsmethode wird im Konto gespeichert, so dass du beim nächsten Mal einfacher bezahlen kannst.",
      buttons: {
        ok: "Weiter",
        ko: "Abbrechen"
      }
    ...
    alertNoActivePaymentMethods: {
      ...
      message:
        "Aktiviere mindestens eine Zahlungsmethode aus deinem Konto oder füge eine neue Zahlungsmethode hinzu.",
      buttons: {
        ok: "Gehe zum Konto",
        ko: "Abbrechen"
      }
    ...
    details: {
      ...
      list: {
        empty: {
          ...
          description:
            "IO hat keine Zahlungsversuche gespeichert. Hier findest du deine letzten Zahlungsversuche"
        },
    ...
    confirm: {
      ...
      editButton: "Ändern",
      termsAndConditions:
        "Wenn du fortfährst, erklärst du folgende Informationen gelesen und verstanden zu haben: ",
  ...
  wallet: {
    methodDetails: {
      ...
      expired:
        "Die Zahlungsmethode ist abgelaufen und kann nicht mehr für In-App-Zahlungen verwendet werden.",
      isSupportedBanner: {
        title: "Möchtest du in der App bezahlen?",
        content:
          "Finde heraus, welche Zahlungsmethoden du in dein Konto aufnehmen kannst.",
        cta: "Mehr erfahren"
      },
      error: {
    ...
    favourite: {
      ...
      setFavoriteSubtitle:
        "Wenn du in der App bezahlst, wird dir IO automatisch diese Zahlungsmethode anzeigen"
    },
    incoming: {
      title: "Demnächst verfügbar",
      message:
        "In einer zukünftigen Version von IO wird diese Zahlungsmethode ebenfalls zur Verfügung stehen"
    },
    featured: "Highlights",
    creditCard: {
      onboardingAttempts: {
        ...
        emptyBody:
          "IO hat keine Versuche Zahlungsmethoden hinzuzufügen gespeichert. Hier findest du deine letzten Versuche",
    ...
    searchAbi: {
      ...
      bancomat: {
        ...
        description: {
          text1:
            "Indem du PagoBANCOMAT zu deinem Konto hinzufügst, kannst du an den auf IO verfügbaren Initiativen teilnehmen.\nWenn du fortfährst, akzeptierst du die ",
          text2: "Datenschutzbestimmungen.",
          text3:
            "Wenn du möchtest, kannst du die Bank wählen, bei der du eine aktive PagoBANCOMAT-Karte hast. ",
      ...
      bpay: {
        ...
        description: {
          text1:
            "Füge BANCOMAT Pay hinzu, um pagoPA-Zahlungsmitteilungen einfacher zu bezahlen sowie an den auf IO verfügbaren Initiativen teilzunehmen.\nWenn du fortfährst, akzeptierst du die ",
          text2: "Datenschutzbestimmungen.",
          text3:
            "Tippe auf 'Weiter', um nach Konten, die auf dich lauten, zu suchen oder suche die Bank, bei der du ein aktives BANCOMAT Pay Konto hast. ",
          text4: "Liste der verfügbaren Banken"
        }
      },
      cobadge: {
        ...
        description: {
          text1:
            "Wenn du alle Maestro-, Mastercard-, V-Pay- und Visa-Karten, die mit dir verbunden sind, zu deinem Konto hinzufügst, können sie an den auf IO verfügbaren Initiativen teilnehmen.",
    ...
    accessibility: {
      ...
      folded: {
        creditCard:
          "{{brand}}-Karte, die Kartennummer endet mit {{blurredNumber}}",
      ...
      cardsPreview:
        "Vorschau der Zahlungsmethoden. Aktiviere, um die Liste deiner Zahlungsmethoden aufzurufen",
    ...
    onboarding: {
      paymentMethodsList: {
        header: {
          ...
          subtitle:
            "Die Zahlungsmethode wird gespeichert und kann verwendet werden, um In-App-Zahlungen vorzunehmen oder kompatiblen Initiativen beizutreten."
        }
      },
      bancomat: {
        ...
        add: {
          ...
          bodySingular:
            "Wir haben eine Karte gefunden, die auf deinen Namen ausgestellt ist. Tippe auf 'Hinzufügen', um diese Karte hinzuzufügen oder tippe auf 'Überspringen', um den Vorgang abzubrechen.",
          bodyPlural:
            "Wir haben {{number}} Karten gefunden, die auf deinen Namen ausgestellt sind. Tippe auf 'Hinzufügen', um diese Karte hinzuzufügen oder tippe auf 'Überspringen', um zur nächsten Karte zu gelangen.",
          loading:
            "Wir fügen gerade deine PagoBANCOMAT-Karte hinzu\n\nWarte ein paar Sekunden...",
          warning:
            "Wenn du nicht all deine Karten findest, versuche später nocheinmal die fehlende Karte hinzuzufügen, indem du die Bank, wo du dein Kontokorrent hast, auswählst.",
          blocked:
            "Diese Karte ist gesperrt und kann daher nicht aktiviert werden, um an den auf IO verfügbaren Initiativen teilzunehmen. Wende dich an deine Bank."
        }
      },
      bPay: {
        headerTitle: "BANCOMAT Pay hinzufügen",
        loadingSearch:
          "Wir rufen deine BANCOMAT Pay Konten ab.\n\nWarte ein paar Sekunden",
        add: {
          label: "BANCOMAT Pay Konto {{current}} von {{length}}",
          screenTitle: "Möchtest du dieses Konto hinzufügen?"
        },
        loadingAdd:
          "Wir fügen gerade dein BANCOMAT Pay Konto hinzu.\n\nWarte ein paar Sekunden",
        koTimeout: {
      ...
      paypal: {
        ...
        selectPsp: {
          title:
            "Mit welchem Dienstleister möchtest du dein PayPal-Konto benutzen?",
          ...
          infoBottomSheet: {
            ...
            ctaTitle: "Verstanden",
            row1Description:
              "{{pspName}} ist ein Zahlungsdienstleister (PSP), der deine Transaktionen über PayPal abwickeln kann.",
            row2Description1:
              "Bei Bezahlung einer Zahlungsmitteilung beträgt die Transaktionsgebühr maximal ",
            row2Description2:
              ". Der genaue Betrag wird dir vor der Bestätigung angezeigt.",
            row3Description1:
              "Es gelten die Nutzungsbedingungen und die Datenschutzbestimmungen von {{psp}}."
          },
        ...
        paypalAlreadyAdded: {
          alert: {
            ...
            message:
              "Wenn du fortfährst, wird das neue Konto dein altes ersetzen."
          }
        },
        onBoardingCompleted: {
          title: "Fertig!",
        ...
        paymentCheckout: {
          ...
          privacyDisclaimer:
            "Wenn du fortfährst, verstehst und akzeptierst du die",
      ...
      coBadge: {
        ...
        search: {
          loading:
            "Wir laden die Liste deiner Karten\n\nWarte bitte ein paar Sekunden",
          koTimeout: {
          ...
          koNotFound: {
            title:
              "Wir haben keine Karten bei Banken, die am Dienst teilnehmen, gefunden",
        ...
        add: {
          screenTitle: "Möchtest du diese Karte hinzufügen?",
          label:
            "Karte mit internationalem Zahlungsnetz {{current}} von {{length}}",
          blocked:
            "Diese Karte ist gesperrt und kann daher nicht aktiviert werden, um an den auf IO verfügbaren Initiativen teilzunehmen. Wende dich an deine Bank.",
          warning1:
            "In einigen Fällen können die angezeigten Daten von denen auf der physischen Karte abweichen: ",
          warning2: "Bei Zweifeln wende dich an deine Bank.",
          loading:
            "Wir fügen die Karte mit internationalem Zahlungsnetz hinzu\n\nWarte ein paar Sekunden..."
        },
        chooseType: {
          title: "Kannst du mit deiner Karte auch online einkaufen?",
          description:
            "Anhand dieser Frage können wir besser verstehen, wie deine Karte funktioniert und dir helfen, sie zu deinem Konto hinzuzufügen.",
          path: {
            enabled: {
              title: "Ja, sie ist für Online-Käufe aktiviert.",
              description:
                "Wir überprüfen die Kartendaten mit deiner Bank, normalerweise per SMS oder Push-Benachrichtigung"
            },
            disabled: {
              title: "Nein, ich benutze sie nur in Geschäften",
              description:
                "Wir durchsuchen alle auf deinem Namen lautenden Karten bei den am Dienst teilnehmenden Banken"
            },
            unknown: {
      ...
      generalError:
        "Beim Hinzufügen der Zahlungsmethode trat ein allgemeiner Fehler auf",
      outcome: {
        SUCCESS: {
        ...
        PSP_ERROR_ONBOARDING: {
          ...
          subtitle:
            "Bitte versuche es später noch einmal. Sollte das Problem weiterhin bestehen, wende dich bitte an deine Bank.",
          primaryAction: "Schließen"
        },
        BE_KO: {
          title:
            "Wir haben einige Probleme beim Hinzufügen der Zahlungsmethode",
    ...
    alert: {
      supportedCardPageLinkError:
        "Beim Öffnen der Übersichtsseite der unterstützten Karten ist ein Fehler aufgetreten.",
      msgErrorUpdateApp:
        "Beim Öffnen des App-Stores ist ein Fehler aufgetreten",
      titlePagoPaUpdateApp: "Update erforderlich",
      messagePagoPaUpdateApp:
        "IO führt häufig kleine Verbesserungen und neue Funktionen ein: Um dein Konto weiterhin nutzen zu können, musst du die App auf die neueste Version aktualisieren.",
      btnUpdateApp: "Aktualisiere die IO-App",
      favorite:
        "Um diese Option zu ändern, wähle eine andere Zahlungsmethode aus deinem Konto und lege diese als bevorzugt fest.",
    ...
    walletLoadFailure:
      "Das Laden der Zahlungsmethoden ist fehlgeschlagen, bitte versuche es erneut.",
    transactionsLoadMessage: "Laden der Transaktionenhistorie...",
    transactionsLoadFailure:
      "Das Laden deiner Transaktionen ist fehlgeschlagen, bitte versuche es erneut.",
    transactionHelpMessage: {
      text1:
        "Probleme mit einer Zahlung oder dem Hinzufügen einer neuen Methode?",
    ...
    newPaymentMethod: {
      ...
      addDescription:
        "Füge eine Zahlungsmethode hinzu, um in Sekundenschnelle in IO zu bezahlen oder fordere die Aktivierung einer Bonus- oder Rabattkarte an.",
      walletAlert:
        "In deinem Konto sind Zahlungsmethoden registriert, aber keine davon ist mit IO kompatibel.",
    ...
    saveCard: {
      ...
      subtitle:
        "Wenn du die Karte zu deinem Konto hinzufügst, kannst du In-App-Zahlungen vornehmen und an Initiativen teilnehmen, die auf IO verfügbar sind.",
      ...
      notice:
        "Um deine Karte zu überprüfen, behalten wir vorübergehend 0,02 € ein. Keine Sorge: Wir werden den Betrag so schnell wie möglich zurückzahlen.",
      temporaryError: "Beim Speichern dieser Karte ist ein Fehler aufgetreten",
      temporarySubError:
        "Wir haben keine Antwort von den Sicherheitssystemen erhalten. Wir entschuldigen uns für die Unannehmlichkeiten.",
      loadWalletsErrorTitle: "Die Systeme benötigen länger als erwartet",
      loadWalletsErrorBody:
        "Wir haben keine Antwort von den Sicherheitssystemen erhalten, aber deine Karte könnte hinzugefügt worden sein. Bitte aktualisiere dein Konto, bevor du es erneut versuchst.",
      loadingAlert: "Deine Kartendaten werden überprüft..."
    },
    challenge3ds: {
      header: "Zahlung autorisieren",
      description:
        "Der Kartenaussteller benötigt deine Bestätigung. Wenn du Probleme hast, wende dich bitte an deine Bank."
    },
    saveCardInPayment: {
    ...
    pickPsp: {
      ...
      info2Bold:
        "die mit deiner Zahlungsmethode kompatibel sind, auch wenn du nicht deren Kunde bist.",
      provider: "Dienstleister",
      maxFee: "Transaktionsgebühr",
      loadingPsps: "Dienstleister werden geladen...",
      onUpdateWalletPspFailure:
    ...
    ConfirmPayment: {
      ...
      identificationMessage:
        "Bestätige die Transaktion durch Eingabe deines Entsperrcodes",
      transactionSuccess: "Die Zahlung wurde abgeschlossen!",
      transactionFailure:
        "Bei der Zahlung ist ein Fehler aufgetreten, bitte versuche es erneut!",
      transactionTimeout:
        "Die Bestätigung der Zahlung konnte nicht abrufen werden!",
      ...
      cancelPaymentSuccess:
        "Die Zahlung dieser Aufforderung wurde abgebrochen, du kannst sie in wenigen Minuten erneut bezahlen",
      accessibility: {
    ...
    payWith: {
      ...
      pickPaymentMethod: {
        ...
        notAvailable: {
          ...
          arriving: {
            bottomSheetTitle:
              "Wir arbeiten an der Unterstützung dieser Zahlungsmethode",
            bottomSheetDescription:
              "Versuche in der Zwischenzeit, mit einer anderen Methode zu bezahlen. Du kannst pagoPA auch in deiner bevorzugten Zahlungs-App oder auf der Website deines Zahlungsempfängers nutzen."
          },
          unaccepted: {
            bottomSheetTitle: "Warum kann ich nicht mit dieser Karte bezahlen?",
            bottomSheetDescription:
              "Das Zahlungsnetzwerk dieser Karte erlaubt es dir an physischen Verkaufsstellen zu bezahlen, aber nicht online. Wenn deine Karte für Online-Zahlungen aktiviert ist, füge sie als 'Debit- oder Kreditkarte' zu deinem Konto hinzu."
          },
          payment_disabled: {
            bottomSheetTitle:
              "Warum kann ich nicht mit dieser Zahlungsmethode bezahlen?",
            bottomSheetDescription:
              "Die Funktion 'In-App-Zahlungen' ist möglicherweise deaktiviert. Bevor du versuchst, die Zahlung erneut vorzunehmen, gehe bitte wie folgt vor:\n\n1. gehe zum Bereich 'Konto';\n2. wähle die gewünschte Zahlungsmethode aus;\n3. aktiviere 'In-App-Zahlungen'."
          }
        }
      }
    },
    firstTransactionSummary: {
      ...
      amountInfo: {
        ...
        message:
          "Wenn sich der Betrag ändert, bedeutet das, dass die Gläubigerinstitution ihn automatisch aktualisiert hat. So kannst du sicher sein, immer den fälligen Betrag zu bezahlen. Falls er höher ist, könnten Zinsen, Strafen oder Benachrichtigungskosten anfallen.\n\nFür weitere Details wende dich bitte an die Gläubigerinstitution, da pagoPA die Gründe für die Aktualisierung nicht kennt.",
        cta: "OK, habe verstanden"
      },
    ...
    errorTransaction: {
      submitBugText:
        "Wenn du das Problem nicht lösen kannst, teile uns dies bitte über das Symbol '?' in der oberen rechten Ecke mit. Danke!"
    },
    insertManually: {
    ...
    noTransactionsInTransactionsScreen:
      "Du hast mit dieser Zahlungsmethode noch nie über IO oder pagoPA bezahlt. In dieser Liste siehst du nur die Transaktionen, die mit dieser Zahlungsmethode durchgeführt wurden.",
    ...
    methods: {
      ...
      card: {
        ...
        pagoPaCapability: {
          ...
          bottomSheetBody:
            "Diese Zahlungsmethode ist nicht für Online-Zahlungen geeignet.",
      ...
      bonus: {
        ...
        description:
          "Initiativen von öffentlichen Verwaltungen zur Unterstützung von Ausgaben oder Dienstleistungen im Zusammenhang mit Zahlungen"
      },
      digital: {
    ...
    dummyCard: {
      ...
      accessibility: {
        ...
        expirationDate: {
          ...
          error:
            "Verfallsdatum, zwei Ziffern für den Monat, zwei für das Jahr. Bitte gib ein gültiges Datum ein"
        },
        securityCode: {
          "3D": {
    ...
    QRtoPay: {
      ...
      cameraUsageInfo:
        "Scanne den QR-Code der Zahlungsmitteilung oder gib die Daten (Zahlungsmitteilungskodex und Steuernummer Körperschaft) manuell ein",
      setManually: "Manuell eingeben",
      enroll_cta:
        "Um den QR-Code auf der Zahlungsmitteilung zu scannen, musst du IO zunächst erlauben, die Kamera zu verwenden. Du kannst dies über das Menü 'Einstellungen' deines Geräts tun.",
      ...
      settingsAlert: {
        ...
        message:
          "IO benötigt Zugang zu deiner Galerie, um Boni und Zertifikate zu speichern oder Screenshots und Zahlungsmitteilungen hochzuladen",
        buttonText: {
    ...
    errors: {
      TECHNICAL:
        "Es gibt ein technisches Problem mit dieser Zahlungsmitteilung",
      DATA: "Die Angaben in der Zahlungsmitteilung sind falsch",
      EC: "Die Körperschaft hat Probleme bei der Beantwortung",
      ONGOING:
        "Die Zahlung ist bereits im Gange, bitte versuche es in ein paar Minuten erneut.",
      ...
      EXPIRED:
        "Die Zahlungsmitteilung ist abgelaufen und kann nicht mehr gezahlt werden",
      ...
      NOT_FOUND_SUBTITLE:
        "Möglicherweise wurde die Zahlungsmitteilung bereits bezahlt. Wende dich bitte an die Körperschaft, die sie ausgestellt hat.",
      INVALID_AMOUNT:
        "Der in der Zahlungsmitteilung angegebene Betrag ist falsch. Wenn du die Daten manuell eingegeben hast, überprüfe bitte, ob sie korrekt sind und versuche es erneut.",
      PAYMENT_EXPIRED:
        "Die Zahlung für diese Zahlungsmitteilung ist nicht mehr möglich, da sie abgelaufen ist.",
      PAYMENT_UNAVAILABLE:
        "Die Zahlung für diese Zahlungsmitteilung ist zur Zeit nicht möglich. Bitte versuche es später noch einmal.",
      PAYMENT_UNKNOWN:
        "Diese Zahlungsmitteilung wird von der ausstellenden Körperschaft nicht anerkannt, die Zahlung kann nicht durchgeführt werden.",
      DOMAIN_UNKNOWN:
        "Dieser Zahlungsmitteilung wurde von einer nicht bei pagoPA akkreditierten Körperschaft ausgestellt, die Zahlung kann nicht durchgeführt werden.",
      MISSING_PAYMENT_ID:
        "Die Körperschaft, die diese Zahlungsmitteilung ausgestellt hat, hat zur Zeit Probleme mit der Zahlungsabwicklung. Versuche es erneut!",
      PAYMENT_ONGOING_NOCANCEL:
        "Eine Zahlung für diese Zahlungsmitteilung ist bereits im Gange, bitte versuche es in 30 Minuten erneut.",
      PAYMENT_ONGOING_NOCANCEL_TIMEOUT:
        "Wenn du bereits 30 Minuten gewartet hast und die Zahlung immer noch blockiert ist, verwende bitte die Schaltfläche unten, um uns eine Nachricht zu senden.",
      PAYMENT_ONGOING_CANCELLED:
        "Dein vorheriger Zahlungsversuch wird abgebrochen, du kannst es in {{remainingMinutes}} Minuten erneut versuchen.",
      PAYMENT_ONGOING_CANCELLED_TIMEOUT:
        "Der Abbruch dieser Zahlung wurde vor mehr als 15 Minuten beantragt, ist aber immer noch blockiert. Bitte benutze die Schaltfläche unten, um uns eine Nachricht zu senden.",
      contactECsubtitle:
        "Wende dich für weitere Informationen an die Körperschaft.",
    ...
    walletCardTransaction: {
      contextualHelpTitle:
        "Mit dieser Zahlungsmethode durchgeführte Transaktionen"
    },
    bancomat: {
      details: {
        debit: {
    ...
    outcomeMessage: {
      ...
      code2: {
        title: "Autorisierung verweigert",
        description:
          "Deine Bank hat die Transaktion nicht genehmigt. Überprüfe, ob du die verschiedenen von deiner Bank geforderten Codes korrekt eingegeben hast."
      },
      code3: {
        title: "Die Daten der Karte sind fehlerhaft",
        description:
          "Lösche die Karte aus deinem Konto und versuche, sie erneut hinzuzufügen. Vergewissere dich, dass die eingegebenen Daten genau mit denen auf der Karte übereinstimmen."
      },
      code4: {
        title: "Prüfe deine E-Mails",
        description:
          "Es war nicht möglich, das Ergebnis der Zahlung zu überprüfen. Wenn sie erfolgreich war, erhältst du in Kürze eine E-Mail mit der Quittung. Solltest du die E-Mail nicht erhalten, wende dich bitte an den Support."
      },
      code7: {
        title: "Es liegt ein Problem mit deiner Karte vor",
        description:
          "Es wurde kein Betrag abgebucht. Für weitere Informationen wende dich bitte an deine Bank."
      },
      code8: {
      ...
      code10: {
        title: "Autorisierung verweigert",
        description:
          "Du hast wahrscheinlich die Obergrenze deiner Zahlungsmethode überschritten. Erkundige dich bei deiner Bank, bevor du es erneut versuchst."
      },
      code15: {
        title: "Zahlungsmethode für In-App-Zahlungen aktivieren",
        description:
          "Bevor du die Zahlung erneut versuchst, wähle die Zahlungsmethode in deinem Konto aus und aktiviere die Funktion 'In-App-Zahlungen'."
      },
      code18: {
        title: "Es ist ein unerwarteter Fehler aufgetreten",
        description:
      ...
      code19: {
        title: "Autorisierung verweigert",
        description:
          "Möglicherweise hast du pagoPA von automatischen PayPal-Zahlungen ausgeschlossen. Lösche das PayPal-Konto aus deinem Konto, füge es wieder hinzu und versuche erneut, die Zahlung vorzunehmen."
      },
      addCreditCard: {
        success: {
    ...
    payment: {
      barcodes: {
        choice: {
          title:
            "Es wurden mehrere Codes entdeckt. Welchen möchtest du verwenden?"
        }
      },
      manual: {
        noticeNumber: {
      ...
      psp: {
        ...
        description:
          "Jeder Zahlungsdienstleister (PSP) schlägt eine Provision vor.",
      ...
      failure: {
        ...
        DOMAIN_UNKNOWN: {
          title:
            "Die ausstellende Körperschaft hat Probleme bei der Bearbeitung",
          subtitle:
            "Bitte versuche es später noch einmal. Wenn das Problem weiterhin besteht, wende dich bitte an den Support."
        },
        PAYMENT_ONGOING: {
          title:
            "Es ist bereits eine Zahlung im Gange, bitte versuche es später noch einmal",
          subtitle:
            "Wenn das Problem weiterhin besteht, kannst du ein Ticket erstellen."
        },
        PAYMENT_EXPIRED: {
          title:
            "Die Zahlungsmitteilung ist abgelaufen und kann nicht mehr bezahlt werden",
          subtitle: "Wende dich für weitere Informationen an die Körperschaft."
        },
        PAYMENT_CANCELED: {
          title:
            "Die ausstellende Körperschaft hat diese Zahlungsmitteilung zurückgezogen",
          subtitle: "Wende dich für weitere Informationen an die Körperschaft.",
        ...
        PAYMENT_VERIFY_GENERIC_ERROR: {
          title:
            "Wir können den Status dieser Zahlungsmitteilung nicht überprüfen",
          subtitle:
            "Bitte versuche es später noch einmal. Wenn das Problem weiterhin besteht, wende dich bitte an den Support."
        },
        GENERIC_ERROR: {
        ...
        PAYMENT_UNKNOWN: {
          ...
          subtitle:
            "Die Zahlungsmitteilung kann bereits bezahlt worden sein. Wende dich bitte an den ausstellende Körperschaft."
        },
        PSP_PAYMENT_METHOD_NOT_AVAILABLE_ERROR: {
          title: "Die ausgewählte Zahlungsmethode ist nicht verfügbar",
          subtitle:
            "Dies kann passieren, wenn der zu zahlende Betrag besonders hoch ist oder wenn du versuchst, eine digitale Steuer- oder Gebührmarke zu bezahlen.",
      ...
      outcome: {
        SUCCESS: {
          ...
          banner: {
            ...
            content:
              "Erzähl uns von deinen Erfahrungen mit der Zahlung und hilf uns, uns zu verbessern.",
            action: "Zur Umfrage"
          }
        },
        GENERIC_ERROR: {
        ...
        INVALID_DATA: {
          ...
          subtitle:
            "Wenn du mit einer Debit- oder Kreditkarte bezahlt hast, musst du die Daten wie auf der Karte angegeben eingeben."
        },
        TIMEOUT: {
          title: "Die Sitzung ist abgelaufen",
          subtitle:
        ...
        CANCELED_BY_USER: {
          title: "Der Vorgang wurde abgebrochen",
          subtitle:
            "Wenn du die Zahlungsmitteilung bezahlen willst, warte ein paar Minuten, bevor du es erneut versuchst."
        },
        EXCESSIVE_AMOUNT: {
          title: "Autorisierung verweigert",
          subtitle:
        ...
        WAITING_CONFIRMATION_EMAIL: {
          ...
          subtitle:
            "Du erhältst das Ergebnis deiner Zahlung mittels E-Mail an {{email}}.",
          defaultSubtitle:
            "Du erhältst das Ergebnis deiner Zahlung mittels E-Mail an die verbundene E-Mail-Adresse."
        },
        METHOD_NOT_ENABLED: {
        ...
        PAYMENT_METHODS_NOT_AVAILABLE: {
          ...
          subtitle:
            "Die Methode wird im Konto gespeichert, so dass du beim nächsten Mal einfacher bezahlen kannst.",
        ...
        PAYMENT_REVERSED: {
          ...
          subtitle:
            "Der autorisierte Betrag wurde auf deine Zahlungsmethode zurücküberwiesen. Die Überweisung kann einige Zeit dauern.",
        ...
        PAYPAL_REMOVED_ERROR: {
          ...
          subtitle:
            "Möglicherweise hast du pagoPA von automatischen PayPal-Zahlungen ausgeschlossen. Lösche das PayPal-Konto aus deinem Konto, füge es wieder hinzu und versuche erneut, die Zahlung durchzuführen."
        },
        IN_APP_BROWSER_CLOSED_BY_USER: {
          title: "Du hast die Zahlung abgebrochen",
          subtitle:
            "Überprüfe das Ergebnis im Tab Zahlungen. Wenn du eine Zahlung vornehmen möchtest, warte bitte mindestens 15 Minuten, bevor du es erneut versuchst."
        },
        INSUFFICIENT_AVAILABILITY_ERROR: {
          title: "Dein Guthaben auf der Karte ist nicht ausreichend.",
          subtitle:
            "Es wurde kein Betrag abgebucht. Bevor du es erneut versuchst, lade die Karte auf oder verwende eine andere Zahlungsmethode."
        },
        CVV_ERROR: {
          title: "Der eingegebene Sicherheitscode ist falsch",
          subtitle:
            "Es wurde kein Betrag abgebucht. Der Code (CVV oder CVC) ist 3-stellig und befindet sich auf der Rückseite der Karte. Bei American Express hat der Code (CID) 4 Ziffern und befindet sich auf der Vorderseite."
        },
        PLAFOND_LIMIT_ERROR: {
          title: "Du hast das Ausgabenlimit deiner Karte überschritten",
          subtitle:
            "Es wurde kein Betrag abgebucht. Bevor du es erneut versuchst, ändere das Ausgabenlimit oder verwende eine andere Zahlungsmethode."
        },
        BE_NODE_KO: {
          title: "Wir haben Probleme mit den Zahlungssystemen",
          subtitle:
            "Überprüfe das Ergebnis der Zahlung im Tab Zahlungen, andernfalls warte einige Minuten, bevor du es erneut versuchst."
        },
        PSP_ERROR: {
          title: "Die Zahlung ist fehlgeschlagen",
          subtitle:
            "Es wurde kein Betrag abgebucht. Sollte das Problem weiterhin bestehen, versuche es mit einer anderen Methode oder einem anderen Zahlungsanbieter."
        },
        AUTH_REQUEST_ERROR: {
          title: "Wir haben Probleme mit den Zahlungssystemen",
          subtitle: "Versuche es später erneut."
  ...
  saveCard: {
    ...
    favoriteText:
      "Diese Zahlungsmethode wird dir automatisch bei der nächsten Zahlung vorgeschlagen"
  },
  cardComponent: {
  ...
  messages: {
    accessibility: {
      message: {
        ...
        archived: "Archiviert",
        description:
          "{{newMessage}}, erhalten von {{organizationName}}, {{serviceName}}. {{subject}}. {{receivedAt}}. {{state}}",
    ...
    cta: {
      ...
      reminderCalendarSelect:
        "In welchem Kalender möchtest du die Erinnerung hinzufügen?",
      reminderTitle: "Erinnerung für: {{title}}",
      reminderAlertTitle: "Ein Ereignis ist bereits vorhanden",
      reminderAlertDescription:
        "Im Kalender gibt es bereits ein vorgemerktes Ereignis, das der ausgewählten Nachricht entspricht. Möchtest du das vorherige beibehalten oder ein neues hinzufügen?",
      ...
      reminderAddFailure:
        "Fehler beim Hinzufügen der Erinnerung, bitte versuche es erneut",
      ...
      reminderRemoveFailure:
        "Fehler beim Entfernen der Erinnerung, bitte versuche es erneut",
      preferenceCalendarSelect: "Wähle deinen Standardkalender",
      calendarPermDenied: {
        title: "Zugriff zulassen",
        description:
          "Wir haben keinen Zugriff auf deinen Kalender. Bitte aktiviere die Berechtigungen, um fortzufahren.",
      ...
      helper:
        "IO merkt sich diese Auswahl, du kannst sie über die App-Einstellungen ändern."
    },
    badge: {
      expired: "Abgelaufen",
      paid: "Bezahlt"
    ...
    archive: {
      emptyMessage: {
        ...
        subtitle:
          "Halte eine Mitteilung gedrückt, um sie in das Archiv zu verschieben. Du kannst auch mehrere Mitteilungen gleichzeitig archivieren. Archivierte Mitteilungen werden nicht gelöscht und stehen in den Suchergebnissen zur Verfügung."
      }
    },
    inbox: {
      emptyMessage: {
        ...
        subtitle:
          "Aktualisiere, um zu prüfen, ob neue Mitteilungen vorhanden sind."
      }
    },
    operations: {
      archive: {
  ...
  messageDetails: {
    ...
    retryText:
      "Es handelt sich wahrscheinlich um einen temporären Fehler... bitte versuche es erneut!",
    submitBugText:
      "Wenn das Problem nicht gelöst ist, lasse es uns bitte über dem '?'-Symbol in der oberen rechten Ecke wissen, danke!",
    dateSending: "Datum und Uhrzeit:",
    sender: "Absender:",
    service: "Dienst:",
    question: "Ist etwas unklar?",
    answer:
      "Wenn du dich über den Inhalt der Mitteilung im Unklaren bist, einen Fehler melden möchtest oder weitere Einzelheiten benötigst, kannst du dich direkt an die Ansprechpartner des Dienstes wenden und dabei die folgende Nachrichten-ID angeben.",
    call: "Anrufen",
    ...
    attachments: {
      ...
      badFormat:
        "Das Format des Anhangs wird nicht unterstützt. Kontaktiere den Absender",
      corruptedFile:
        "Der Anhang ist beschädigt und kann nicht geöffnet werden. Kontaktiere den Absender",
      downloadFailed:
        "Der Anhang ist derzeit nicht verfügbar. Bitte versuche es erneut oder kontaktiere den Absender",
      showPreview: "Vorschau anzeigen",
      failing: {
        details:
          "Der Anhang konnte nicht heruntergeladen werden. Bitte versuche es erneut oder öffne eine Ticket"
      }
    },
    banner: {
      ...
      content3:
        "der Inhalt kann sich im Laufe der Zeit ändern, damit du aktuelle Informationen erhältst.",
  ...
  messagePDFPreview: {
    ...
    savedAtLocation:
      "Das Dokument {{name}} wurde im Ordner Download gespeichert.",
    share: "Teilen",
    ...
    errors: {
      ...
      opening:
        "Beim Öffnen des Dokuments ist ein Fehler aufgetreten. Möglicherweise hast du keine PDF-App installiert.",
  ...
  notifications: {
    profileBanner: {
      title:
        "Aktiviere Push-Benachrichtigungen, damit du weißt, wenn du eine Mitteilung auf IO erhältst.",
      cta: "Push-Benachrichtigungen aktivieren"
    },
    installation: {
      errorTitle: "Push-Benachrichtigungen",
      errorMessage:
        "Bei der Registrierung des Push-Benachrichtigungsdienstes ist ein Fehler unterlaufen"
    },
    modal: {
      content:
        "Aktiviere Push-Benachrichtigungen, um sofort zu erfahren, wenn du eine neue Mitteilung in der App erhältst.",
  ...
  biometric_recognition: {
    ...
    enroll_cta:
      "Die biometrische Erkennung ist auf diesem Gerät vorhanden, aber nicht konfiguriert. Wechsle zu den Einstellungen deines Geräts und aktiviere dort den Dienst, um diese Funktion zu nutzen.",
  ...
  send_email_messages: {
    ...
    subtitle:
      "Möchtest du, dass IO eine Vorschau der Mitteilung an die E-Mail-Adresse sendet:",
    switch: {
      title: "Eine Vorschau per E-Mail senden",
      subtitle:
        "Du erhältst eine Vorschau der Mitteilung an deine E-Mail-Adresse, sofern der Dienst dies zulässt."
    }
  },
  services: {
    optIn: {
      preferences: {
        ...
        banner:
          "Du kannst deine Wahl jederzeit unter Einstellungen > Einstellungen ändern",
        ...
        quickConfig: {
          ...
          label:
            "Alle Dienste, die du nicht deaktiviert hast, können dich kontaktieren.",
          title: "Schnelleinrichtung benutzen",
          successAlert: "Du hast die Schnelleinrichtung aktiviert",
          body: {
            text1:
              "Nur Dienste, die dir etwas Wichtiges mitzuteilen haben, werden dich kontaktieren.",
            text2:
              "Du kannst die Mitteilungen von Diensten, die dich nicht interessieren, jederzeit deaktivieren."
          }
        },
        manualConfig: {
          value: "Manuelle Konfiguration",
          label:
            "Nur die Dienste, die du aktiviert hast, können dich kontaktieren.",
          title: "Manuell konfigurieren",
          successAlert: "Du hast die manuelle Konfiguration aktiviert",
          body: {
            text1:
              "Kein Dienst wird dich kontaktieren können. Um Mitteilungen zu empfangen, musst du sie einzeln konfigurieren."
          },
          bottomSheet: {
    ...
    search: {
      ...
      emptyState: {
        ...
        noResults: {
          ...
          subtitle:
            "Gib den Namen einer bestehenden nationalen oder lokalen Körperschaft ein."
        }
      }
    },
    details: {
  ...
  identification: {
    ...
    logoutDescription:
      "Du kannst dich mit deinem SPID oder deiner CIE anmelden. Diese Sitzung wird abgemeldet.",
    logoutDescriptionProfileName:
      "Du kannst dich mit deinem SPID oder deiner CIE anmelden. Die Sitzung von {{profileName}} wird abgemeldet.",
    biometric: {
    ...
    forgetCode: {
      ...
      confirmMsg:
        "Um einen neuen Entsperrcode festlegen zu können, musst du dich erneut anmelden.",
      confirmMsgWithTask:
        "Um einen neuen Entsperrcode festlegen zu können, musst du den aktuellen Vorgang abbrechen und dich neu anmelden."
    }
  },
  calendarEvents: {
  ...
  messageUpdateApp:
    "IO führt häufig kleine Verbesserungen und neue Funktionen ein: Um die App weiterhin nutzen zu können, ist es notwendig, sie auf die neueste Version zu aktualisieren.",
  titleUpdateAppAlert: "Um fortzufahren, aktualisiere IO",
  messageUpdateAppAlert:
    "Es ist eine neue Version von IO auf {{storeName}} verfügbar, aktualisiere sie, um diese Funktion zu nutzen.",
  ...
  bonus: {
    ...
    state: {
      completed: {
        caption: "beendet",
        description:
          "Diese Initiative ist beendet und kann nicht mehr beantragt werden."
      }
    },
    bonusList: {
    ...
    termsAndConditionFooter:
      'Premendo "{{ctaText}}" dichiari di essere in possesso dei requisiti e di aver letto e compreso la [Guida]({{regulationLink}}) e l\'[Informativa Privacy]({{tosUrl}})',
    tos: {
    ...
    cgn: {
      generic: {
        linkError:
          "Die Website des Anbieters ist zur Zeit nicht erreichbar. Bitte versuche es später noch einmal."
      },
      accessibility: {
      ...
      departmentName:
        "Präsidium des italienischen Ministerrates, Abteilung für Jugendpolitik und Zivildienst",
      merchantSearch: {
        goToSearchAccessibilityLabel: "Zur Suche der Teilnehmer gehen",
        emptyList: {
          shortQuery: {
            titleWithCount:
              "Suche unter {{merchantCount}} Partnern der Nationalen Jugendkarte",
            titleWithoutCount:
              "Suche bei den Partnern der Nationalen Jugendkarte"
          },
          noResults: {
            title: "Wir haben nichts gefunden",
            subtitle:
              "Versuche, mit anderen Begriffen zu suchen.\nWenn du nicht fündig wirst, ist der Partner möglicherweise nicht beigetreten oder hat keine aktiven Angebote."
          }
        },
        input: {
          placeholder: "Suchen",
      ...
      detail: {
        ...
        information: {
          active:
            "Die Karte ist aktiv und kann bis zum {{date}} verwendet werden.",
          warning: "Achtung! ",
          revoked:
            "Diese Karte wurde aus folgendem Grund widerrufen: {{reason}}",
      ...
      activation: {
        ...
        error: {
          title:
            "Der Dienst Nationale Jugendkarte ist derzeit nicht verfügbar.",
          body: "Es tut uns leid, bitte versuche es später noch einmal."
        },
        ineligible: {
          title:
            "Leider erfüllst du nicht die Voraussetzungen für die Nationale Jugendkarte.",
        ...
        deactivate: {
          ...
          alert: {
            ...
            message:
              "Die Karte wird deaktiviert und du hast keinen Zugang mehr zu den verfügbaren Vorteilen."
          },
      ...
      otp: {
        error:
          "Aufgrund eines technischen Problems war es uns nicht möglich, einen Rabattcode zu generieren. Bitte versuche es erneut.",
        code: {
  ...
  features: {
    messages: {
      ...
      updateBottomSheet: {
        ...
        subtitle:
          "App IO Version {{value}} ist erforderlich, um diese Funktion zu nutzen. Bitte aktualisiere die App, um fortzufahren."
      },
      badge: {
    ...
    pn: {
      ...
      details: {
        ...
        cancelledMessage: {
          ...
          unpaidPayments:
            "Für die Erstattung von Zahlungen im Zusammenhang mit diesem Bescheid wende dich bitte an den Absender.",
          unpaidPaymentsNew:
            "Für die Erstattung von Zahlungen wende dich bitte an die Körperschaft.",
          payments: "Zahlungen"
        },
        paymentSection: {
          title: "pagoPA-Zahlungsmitteilungen",
        ...
        f24Section: {
          title: "F24-Formulare",
          description:
            "Wenn du es vorziehst, kannst du diesen Bescheid über F24 bezahlen.",
        ...
        timeline: {
          ...
          newInfo:
            "In der Web-Version findest du weitere Einzelheiten, Quittungen und Bescheinigungen, die gegenüber Dritten vollstreckbar sind.",
          ...
          status: {
            ...
            EFFECTIVE_DATE:
              "Abgeschlossen wegen Ablaufs der Hinterlegungsfrist",
    ...
    wallet: {
      home: {
        emptyMessage:
          "Verwahre hier deine Zahlungsmethoden, die Nationale Jugendkarte, Boni und Rabatte.",
    ...
    payments: {
      ...
      methods: {
        ...
        banner: {
          content:
            "Füge dem Konto eine Zahlungsmethode hinzu, damit du nicht jedes Mal die Daten eingeben musst.",
      ...
      transactions: {
        ...
        empty: {
          ...
          content:
            "Bezahle eine Zahlungsmitteilung in der App oder mittels jedem pagoPA-fähigen Kanal."
        },
        status: {
          failure: "FEHLGESCHLAGEN",
          success: ""
        ...
        receipt: {
          ...
          hideBanner: {
            ...
            content:
              "Dieser Vorgang ist unwiderruflich. Die Quittung wird nicht mehr in deiner Quittungsliste angezeigt.",
            accept: "Ja, ausblenden"
          }
        },
        details: {
          totalFeeUnknown:
            "Der Gesamtbetrag enthält keine Provisionskosten: du findest diese in dem Dokument, das du von {{pspName}} erhalten hast.",
          totalFeeUnknownPsp:
            "Die Gesamtsumme enthält keine Provisionskosten: du findest diese in dem Dokument, das du vom Zahlungsdienstleister (PSP) erhalten hast."
        },
        error: {
          banner: {
        ...
        list: {
          empty: {
            ...
            subtitle:
              "Wenn du eine Quittung für eine pagoPA-Zahlungsmitteilung suchst, die du in der Vergangenheit bezahlt hast, wende dich an den Gläubiger."
          },
          emptyPayer: {
            title:
              "Hier findest du Quittungen für Zahlungen, die mit der App getätigt wurden."
          }
        }
      },
      details: {
    ...
    itWallet: {
      ...
      ipzsPrivacy: {
        ...
        warning:
          "Indem du auf **Weiter** tippst, erklärst du, dass du den **Datenschutzhinweis** gelesen und verstanden hast.",
        button: {
          label: "Weiter"
        }
      },
      ...
      discovery: {
        ...
        upcomingWalletBanner: {
          ...
          content:
            "Bald kannst du digitale Versionen deiner persönlichen Dokumente wie Führerschein und Gesundheitskarte in dein IO-Konto einfügen!",
          action: "Mehr erfahren"
        },
        alreadyActive: {
          title: "Dokumente in IO ist bereits aktiv",
          content:
            "Füge weiterhin digitale Versionen deiner Dokumente zu deinem Konto hinzu.",
      ...
      identification: {
        mode: {
          ...
          description:
            "Dies ist ein notwendiger Schritt, um die Sicherheit deiner Daten zu gewährleisten.",
        ...
        nfc: {
          ...
          description:
            "Damit IO deine CIE lesen kann, aktiviere NFC in den Einstellungen deines Geräts.",
          header: "Wie geht das",
          steps: {
        ...
        notMatchingIdentityScreen: {
          ...
          message:
            "Wenn du dich von einem anderen Gerät als dem üblichen (z. B. dem einer anderen Person) in IO anmeldest, werden aus Sicherheitsgründen diese Funktionalitäten zurückgesetzt:\n\n- Dokumente in IO",
          banner: {
            title:
              "Wir empfehlen, dass du nur von deinem Gerät aus auf die App zugreifst."
          },
          alert: {
            title: "Möchtest du dich wirklich abmelden?",
            message:
              "Du musst dich erneut mit SPID oder CIE anmelden, um die App nutzen zu können."
          }
        },
        loading: {
          cieId: {
            ...
            subtitle:
              "Bestätige den Zugang in der CieID-App, um die Verbindung fortzusetzen oder abzubrechen",
      ...
      issuance: {
        credentialAuth: {
          ...
          subtitle:
            "Sie werden mit **{{organization}}** für die Bereitstellung der digitalen Version des Dokuments geteilt.",
        ...
        credentialPreview: {
          ...
          bottomSheet: {
            about: {
              title: "Wer ist das?",
              subtitle:
                "Das ist die Körperschaft, die dir die digitale Version deiner Dokumente zur Verfügung stellt.\n\nUm zu erfahren, wie sie deine Daten verarbeitet, konsultiere bitte die [Datenschutzrichtlinie]({{privacyUrl}})."
            },
            authSource: {
              title: "Wer ist das?",
              subtitle:
                "Es ist die Körperschaft, die die in deinem Dokument enthaltenen Daten bereitstellt."
            }
          },
          actions: {
        ...
        eidResult: {
          success: {
            ...
            subtitle:
              "Du kannst nun das erste Dokument in das IO-Konto aufnehmen.",
            toast: "Erledigt!",
            actions: {
        ...
        credentialNotFound: {
          ...
          subtitle:
            "Um Dokumente in IO zu verwenden, füge sie zunächst dem Konto hinzu. Das geht schnell und einfach."
        }
      },
      unsupportedDevice: {
      ...
      presentation: {
        alerts: {
          ...
          mdl: {
            content:
              "Du kannst deinen Führerschein nur in Italien verwenden, um bei einer Polizeikontrolle deine Fahrtauglichkeit nachzuweisen."
          },
          ehc: {
            content:
              "Du kannst deine Gesundheitskarte - Europäische Krankenversicherungskarte auf IO verwenden, um Dienstleistungen des nationalen Gesundheitsdienstes in Anspruch zu nehmen."
          },
          edc: {
            content:
              "Du kannst deinen Europäischen Behindertenausweis auf IO verwenden, um Dienstleistungen auf italienischem Gebiet in Anspruch zu nehmen, und zwar in denselben Verwendungszusammenhängen wie dein physisches Dokument."
          },
          expired: {
            content:
              "Das Dokument ist nicht mehr gültig. Wenn du das neue gültige Dokument bereits hast, kannst du die digitale Version im Konto aktualisieren",
            action: "Dokument aktualisieren"
          },
          expiring: {
            content:
              "Es verbleiben noch {{days}} Tage, bevor das Dokument abläuft."
          },
          verificationExpiring: {
            content:
              "Überprüfe die digitale Version deines Dokuments bis zum {{date}}."
          }
        },
        bottomSheets: {
          eidInfo: {
            ...
            contentTop:
              "Mit **Dokumente in IO** speicherst du digitale Versionen deiner Dokumente im IO-Konto.",
            contentBottom:
            ...
            alert: {
              ...
              expired:
                "Für die weitere Nutzung von Dokumente in IO ist ein kurzer Überprüfungsschritt erforderlich."
            }
          },
          MDL: {
            expiring: {
        ...
        credentialDetails: {
          ...
          fiscalCode: {
            ...
            action:
              "Tippe, um den Barcode zu vergrößern und im Vollbildmodus anzuzeigen."
          },
          status: {
            valid: "Gültig",
            invalid: "Ungültig",
          ...
          dialogs: {
            remove: {
              ...
              content:
                "Wenn du deine Meinung änderst, kannst du es später wieder hinzufügen.",
          ...
          verificationExpired: {
            ...
            content:
              "Dies ist ein notwendiger Sicherheitsschritt, um das Dokument '{{credentialName}}' in IO weiter zu verwenden.",
            primaryAction: "Start"
          }
        },
        ctas: {
      ...
      trustmark: {
        description:
          "Zeige den QR-Code vor, um die Echtheit des Dokuments zu bestätigen, wenn du dazu aufgefordert wirst.",
      ...
      walletRevocation: {
        ...
        failureScreen: {
          title: "Ein unerwarteter Fehler ist aufgetreten",
          subtitle:
            "Der Dienst konnte nicht deaktiviert werden. Bitte versuche es erneut."
        }
      },
      feedback: {
        banner: {
          ...
          content:
            "Erzähle uns von deinen Erfahrungen mit der Funktion Dokumente in IO.",
          action: "Start"
        }
      },
      walletInstanceRevoked: {
        alert: {
          ...
          revokedByWalletProvider: {
            ...
            content:
              "Um die Voraussetzungen für die weitere Nutzung der Funktionen auf deinem Gerät zu prüfen, tippe auf 'Mehr erfahren'."
          },
          newWalletInstanceCreated: {
            title: "Dokumente in IO wurde auf diesem Gerät deaktiviert",
            content:
              "Aus Sicherheitsgründen kannst du deine IO-Dokumente immer nur auf einem Gerät gleichzeitig verwenden."
          },
          revokedByUser: {
  ...
  support: {
    ...
    helpCenter: {
      ...
      supportComponent: {
        ...
        subtitle:
          "Wirf einen Blick in die FAQ: Wenn du die gesuchte Antwort nicht findest, erstelle ein Ticket. Wenn du bereits eine Ticket eröffnet hast und dessen Status überprüfen oder Details hinzufügen möchtest, wähle bitte 'Offene Tickets'.",
        adviceMessage:
          "Wenn dein Problem den Inhalt einer Nachricht oder den Dienst einer Körperschaft betrifft, wende dich bitte an die Körperschaft: du findest die entsprechenden Kontaktdaten in der Nachricht oder in den Details des Dienstes."
      }
    },
    panicMode: {
    ...
    askPermissions: {
      ...
      appVersionsHistoryValue:
        "Um herauszufinden, ob das Problem von der letzten Aktualisierung abhängt",
      identityProvider: "Identitätsanbieter",
      navigationData: "IO-App Navigationsdaten",
      navigationDataValue:
        "z.B. der letzte Bildschirm oder die letzte in der IO-App angezeigte Nachricht",
      ...
      listBody:
        "Um deine offenen Tickets laden zu können, benötigen wir Zugriff auf einige deiner Daten.",
      ...
      toast: {
        emailClientNotFound:
          "Wenn du Hilfe benötigst, schreib uns an: {{emailAddress}}"
      }
    },
    chooseCategory: {
      header: "Erstelle ein Ticket",
      ...
      subTitle: {
        category:
          "Hilf uns, besser zu verstehen, wie wir dir helfen können, indem du den Bereich deines Problems auswählst: Wir werden uns so schnell wie möglich während der Geschäftszeiten bei dir melden."
      }
    }
  },
  barcodeScan: {
    ...
    permissions: {
      undefined: {
        ...
        label:
          "Erlaube den Zugriff, um QR-Codes mit der Kamera deines Geräts scannen zu können.",
        action: "Zugriff gewähren"
      },
      denied: {
        title: "Du hast den Zugriff verweigert, die Kamera zu benutzen",
        label:
          "Um den Zugriff zu gewähren, geh zu den Einstellungen deines Betriebssystems.",
  ...
  unsupportedDevice: {
    ...
    subtitle:
      "Stell sicher, dass dein Betriebssystem auf die neueste Version aktualisiert ist. Wenn dies bereits der Fall ist, musst du dich von einem anderen Gerät aus anmelden, um IO weiter nutzen zu können.",
    cta: {
      faq: "Warum?"
    }
  },
  fastLogin: {
    ...
    userInteraction: {
      sessionExpired: {
        noPin: {
          ...
          subtitle:
            "Aus Sicherheitsgründen musst du dich erneut mit SPID oder CIE identifizieren. Anschließend kannst du die IO-Konfiguration dort fortfahren, wo du aufgehört hast.",
        ...
        transientError: {
          ...
          subtitle:
            "Schließ die App und versuche es in ein paar Minuten erneut.",
    ...
    whatsNew: {
      ...
      subtitle:
        "Du musst dich jetzt nur noch einmal im Jahr mit deinem SPID oder deiner CIE authentifizieren. Danach brauchst du dich nur noch mit deinem Entsperrcode oder biometrischen Merkmalen anmelden."
    }
  },
  whatsNew: {
  ...
  transaction: {
    details: {
      ...
      totalFeeNoPsp:
        "Provision, die vom Transaktionsdienstleister (PSP) erhoben wird.",
      bannerImported: {
        content:
          "Die pagoPA-Quittung ist nicht verfügbar. Wende dich an den Zahlungsempfängers, wenn du den Zahlungsbeleg, d. h. das Dokument, das die Begleichung einer Schuld bescheinigt, benötigst."
      },
      info: {
        ...
        alert: {
          content:
            "Wende dich an den Gläubiger, wenn du die Quittung benötigst."
        }
      },
      operation: {
        amount: "Betrag",
  ...
  FIMS: {
    ...
    history: {
      errorStates: {
        ...
        toast:
          "Beim Laden der Liste ist ein Problem aufgetreten. Bitte versuche es erneut"
      },
      emptyBody: "Du hast noch keine Dienste Dritter in Anspruch genommen",
      exportData: {
        alerts: {
          areYouSure:
            "Willst du wirklich eine Kopie aller Zugänge exportieren?",
          alreadyExporting: {
        ...
        errorToast:
          "Beim Senden der Anfrage ist ein Problem aufgetreten. Bitte versuche es erneut"
      },
      profileCTA: {
    ...
    consentsScreen: {
      errorStates: {
        ...
        general: {
          ...
          title:
            "Es liegt ein vorübergehendes Problem vor, bitte versuche es später noch einmal."
        },
        missingInAppBrowser: {
      ...
      inAppBrowserError:
        "Beim Senden der Anfrage ist ein Problem aufgetreten. Bitte versuche es erneut",
      title:
        "Um auf den Dienst zugreifen zu können, müssen die folgenden Daten freigegeben werden",
      ...
      bottomSheet: {
        ...
        body2:
          "Deine Daten sind sicher und werden nur zu den Zwecken verarbeitet, die von der Körperschaft angegeben sind.",
