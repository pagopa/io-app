export default {
  ...
  global: {
    ...
    accessibility: {
      ...
      linkHint:
        "Attivando questo elemento verrai reindirizzato sul browser del dispositivo",
      alert: "Avviso",
      activityIndicator: {
  ...
  permissionRationale: {
    storage: {
      ...
      message:
        "Potrai salvare bonus e certificati, caricare screenshot e avvisi di pagamento."
    },
    camera: {
    ...
    calendar: {
      ...
      message:
        "Potrai aggiungere le scadenze al tuo calendario e impostare un promemoria."
    },
    torch: {
      title: "Consenti l’accesso alla fotocamera",
      message:
        "Abbiamo bisogno dell'accesso alla fotocamera per utilizzare la torcia."
    }
  },
  startup: {
    ...
    userDeletePendingAlert: {
      ...
      message:
        "Se hai cambiato idea, puoi annullare la richiesta dalla sezione Privacy all'interno delle Impostazioni.",
    ...
    slowdowns_results_screen: {
      ...
      subtitle:
        "Può dipendere dai nostri sistemi o dalla connessione del tuo dispositivo. Riprova tra qualche minuto."
    },
  ...
  login: {
    expiration_info:
      "Per ragioni di sicurezza, dovrai entrare con SPID o CIE ogni 30 giorni.",
    expiration_info_FL:
      "Per ragioni di sicurezza, dovrai entrare con SPID o CIE una volta all’anno.",
    biometric_info:
      "Per accedere, ti basterà poi inserire il codice di sblocco o, se abilitati, usare l'impronta o il volto."
  },
  inbox: {
  ...
  settings: {
    informativeBanner: {
      content:
        "Cerchi il Profilo? Lo abbiamo spostato, ora è in alto a destra!",
  ...
  profile: {
    ...
    main: {
      ...
      privacy: {
        ...
        subtitle:
          "Qui trovi informazioni sui tuoi diritti e obblighi e sul trattamento dei dati personali.",
        loading:
          "Attendi qualche secondo, stiamo verificando il tuo profilo...",
        errorMessage:
          "Non riusciamo a recuperare lo stato delle tue richieste. Riprova.",
        removeAccount: {
          ...
          alert: {
            ...
            activeBonusDescription:
              "Sembra che tu abbia aderito ad alcune iniziative presenti su IO. Se elimini il tuo profilo, l’iscrizione a eventuali iniziative a cui hai aderito non verrà cancellata\n\nPer gestirle, vai alla sezione Portafoglio, altrimenti scegli “Elimina”",
          ...
          info: {
            ...
            banner:
              "Il tuo profilo sarà eliminato definitivamente entro 30 giorni dalla richiesta.",
            body: {
              p1: "Se decidi di proseguire non potrai più recuperare i messaggi o le preferenze che hai impostato nell'app.",
              p2: {
                firstPart:
                  "Eventuali bonus o sconti ottenuti tramite l'app IO ",
        ...
        exportData: {
          ...
          subtitle:
            "Puoi scaricare i dati principali del tuo profilo IO in qualsiasi momento.",
          ...
          detail: {
            ...
            paragraph2: {
              ...
              part3:
                "in cui sono presenti un link e una password validi per 15 giorni."
            },
            paragraph3: {
        ...
        privacyPolicy: {
          ...
          description:
            "Consulta l’Informativa Privacy e i Termini e condizioni d’uso di IO",
          header:
        ...
        shareData: {
          ...
          listItem: {
            ...
            description:
              "Aiuta il team di IO a monitorare il funzionamento dell’app"
          },
          screen: {
            title: "I tuoi dati su IO",
            description:
              "Se condividi i tuoi dati, ci aiuti a migliorare la tua esperienza su IO e a fornirti assistenza mirata.",
            why: {
              description: {
                one: "Usiamo ",
                two: "solo i dati necessari ",
                three:
                  "a monitorare il funzionamento dell’app e a migliorare i servizi offerti."
              },
            ...
            profileSettings:
              "Puoi modificare la tua scelta in ogni momento da Impostazioni > Privacy e Condizioni d’uso",
            cta: {
              shareData: "Condividi",
      ...
      appInfo: {
        ...
        subtitle:
          "Qui puoi trovare ulteriori dettagli sull'app IO e scoprire di più sul suo utilizzo.",
    ...
    data: {
      title: "I tuoi dati",
      subtitle:
        "Qui trovi i tuoi dati anagrafici e di contatto utilizzati da app IO",
      list: {
    ...
    preferences: {
      title: "Preferenze",
      subtitle:
        "Queste impostazioni ti permettono di personalizzare la tua esperienza su IO.",
      ...
      notifications: {
        ...
        subtitle:
          "Scegli se mostrare le anteprime e ricevere promemoria, come in questo esempio.",
        titleExistingUser: "Personalizza le notifiche",
        subtitleExistingUser:
          "Ora puoi vedere subito chi ti ha scritto o ricevere promemoria da messaggi importanti, come in questo esempio.",
        reminders: {
          title: "Consenti promemoria",
          description:
            "Su richiesta dell'ente, ricevi notifiche push in prossimità di scadenze o quando hai dei messaggi non letti"
        },
        preview: {
          title: "Mostra anteprime",
          description:
            "Includi nella notifica push il mittente e l’oggetto del messaggio.",
          link: "Scopri di più",
          bottomSheet: {
            title: "Mostra anteprime",
            content:
  ...
  navigation: {
    ...
    accessibilityWithBadge:
      "Sezione {{section}}, {{unread}} nuovi elementi, pannello, {{order}} di 4",
  ...
  authentication: {
    landing: {
      ...
      "card0-content-accessibility":
        "Seleziona elemento precedente per aprire una chat con il team di IO se qualcosa non funziona come dovrebbe.",
      "card1-title": "Conserva al sicuro i tuoi documenti personali",
      "card1-content":
        "Con Documenti su IO hai sempre a portata di mano la versione digitale dei tuoi documenti, come Patente e Tessera Sanitaria",
      "card2-title": "Ricevi comunicazioni, anche a valore legale",
      "card2-content":
        "Leggi le comunicazioni in arrivo dagli enti: se attivi il servizio SEND, ricevi anche quelle a valore legale e risparmi sui costi di notifica",
      "card3-title": "Paga gli avvisi pagoPA con il metodo che preferisci",
      "card3-content":
        "Su IO consulti e scarichi le ricevute dei tuoi pagamenti pagoPA, anche se non hai pagato in app",
      "card4-title": "Accedi ai servizi che più ti interessano",
      "card4-content":
        "Accedi direttamente a servizi della Pubblica Amministrazone dedicati a salute, educazione, mobilità, lavoro e molto altro",
      expiredCardTitle: "La verifica della CIE non è andata a buon fine",
      expiredCardHeaderTitle: "Entra con CIE",
      expiredCardContent:
        "La carta utilizzata potrebbe essere scaduta o non più valida. Prova ad usare SPID per entrare in app.",
      expiredCardHelp:
    ...
    wizards: {
      ...
      cie_pin_wizard: {
        ...
        description:
          "Se hai la tua Carta di Identità Elettronica a portata di mano, puoi accedere a IO inserendo il PIN della carta e avvicinandola al dispositivo per consentire la lettura dei dati.",
        actions: {
          primary: {
      ...
      spid_wizard: {
        title: "Hai SPID?",
        description:
          "Se hai SPID, entra su IO inserendo le tue credenziali, usando il tuo volto o l’impronta, oppure tramite l’app del tuo fornitore di SPID.",
        actions: {
          primary: {
      ...
      id_activation_wizard: {
        ...
        description:
          "Devi avere un’identità digitale SPID o CIE (Carta di Identità Elettronica) attiva per usare IO.",
        list_items: {
    ...
    auth_errors: {
      ...
      missing_saml_response: {
        title: "Non è stato possibile accedere",
        subtitle:
          "Al momento non è possibile accedere con il tuo fornitore d’identità SPID. Riprova tra qualche minuto."
      },
      generic: {
        title: "Non è stato possibile accedere",
        subtitle:
    ...
    cie_id: {
      error_screen: {
        ...
        cie_pin_supported: {
          description:
            "Se hai la tua Carta di Identità Elettronica a portata di mano, usala per accedere a IO.\n\nInserisci il PIN della CIE e avvicinala al dispositivo per consentire la lettura dei dati.",
          primary_action_label: "Entra con CIE + PIN"
        },
        cie_pin_not_supported: {
          description:
            "Se hai SPID, entra su IO inserendo le tue credenziali. Puoi usare anche il tuo volto o l’impronta o il codice impostato per l’app del tuo fornitore di SPID.",
      ...
      cie_not_installed: {
        ...
        description:
          "Per accedere, devi avere l'app installata sul tuo dispositivo.",
        primary_action_label: "Scarica CieID",
        link_error:
          "Non siamo riusciti a indirizzarti allo store. Aprilo manualmente e cerca CieID"
      }
    },
    cie: {
      ...
      nfc: {
        apduNotSupported:
          "Il sistema operativo non supporta la lettura della Carta di Identità Elettronica. Prova ad usare SPID per entrare in app.",
        retry: "Riprova",
        ...
        activeNfcAlert:
          "Attiva l’NFC per permettere a IO di leggere la tua CIE!",
      ...
      pin: {
        ...
        incorrectCiePinContent1:
          "Hai ancora 2 tentativi, controllalo e riprova.",
      ...
      card: {
        ...
        layCardMessageHeader:
          "Se la lettura non parte, sposta la carta in punti diversi e attendi qualche secondo finché non senti una vibrazione.",
        layCardMessageHeaderiOS:
          "Se la carta non viene letta, spostala in punti diversi e attendi qualche secondo.",
        layCardMessageFooter:
        ...
        iosAlert: {
          readingInstructions:
            "Appoggia la tua carta d’identità elettronica nella parte alta del telefono.",
          moreTags:
            "Sono state individuate più carte. Per favore avvicina una carta alla volta.",
          readingInProgress:
        ...
        error: {
          ...
          unknownCardContent:
            "La carta utilizzata non sembra essere una Carta di Identità Elettronica.",
          unknownCardHelpLink: "Che cos'è la Carta di Identità Elettronica?",
          genericErrorTitle:
            "Non siamo riusciti a recuperare i dati dalla carta",
          genericErrorSubtitle:
            "Se riscontri più volte il problema, attendi qualche minuto e riprova."
        }
      }
    },
    spid: "SPID",
    ...
    opt_in: {
      ...
      contextualHelpContent:
        "Qui puoi trovare le informazioni sulle modalità di autenticazione su IO e alcuni consigli di sicurezza.",
      news: "novità",
      title: "Ora è più facile accedere!",
      identity_check:
        "Non dovrai più identificarti con SPID o CIE ogni 30 giorni, ma solo una volta all’anno o se esci dall’app",
      security_suggests: "Alcuni consigli di sicurezza",
      passcode:
        "Per tutte le altre volte basterà il tuo volto, impronta o codice di sblocco",
      notification:
        "Riceverai un’email a ogni nuovo accesso. Se non lo riconosci, potrai bloccare l’accesso a IO",
      button_accept_lv: "Continua con l’accesso rapido",
      button_decline_lv: "Entra con SPID o CIE ogni 30 giorni"
    },
    security_suggestions: {
      fingerprint:
        "Non condividere il tuo codice di sblocco o riconoscimento biometrico con nessuno",
      io_logout: "Se perdi il dispositivo, esci dall’app da web",
      io_lock_access:
        "Se temi che qualcuno possa usare il tuo SPID o CIE, puoi bloccare l’accesso all’app entrando dal web",
      access_new_device:
        "Se accedi a IO con un dispositivo di altri, ricordati di uscire dall’app quando hai finito",
    ...
    idp_login: {
      ...
      poste_id: {
        bottom_sheet: {
          ...
          feature_1:
            'Tocca su **"Accedi più rapidamente"** nella fascia grigia al centro della schermata',
          feature_2: "Inserisci il codice PosteID o usa il biometrico",
          feature_3:
            "Quando vedrai apparire **Autorizzazione concessa**, torna su IO e premi **Acconsento**"
        }
      }
    },
    idp_login_success: {
    ...
    unlock: {
      ...
      subtitlel3:
        "Per poter accedere all’app con tutte le tue identità SPID o CIE, sblocca l’accesso.",
    ...
    unlockmodal: {
      title: "Cosa significa?",
      description1_1:
        "Se hai bloccato l’accesso a IO per motivi di sicurezza, per poter rientrare in app devi prima sbloccarlo.",
      description1_2:
        "In alternativa, è possibile entrare in app utilizzando un accesso con il",
      description1_3: "livello massimo di sicurezza.",
      description1_4:
        "Questo tipo di autenticazione richiede un nome utente, una password e un supporto fisico, come ad esempio la CIE.",
      title2: "Vuoi sbloccare l’accesso a IO?",
      listitem1:
        "Assicurati di aver messo in sicurezza la tua identità digitale, modificando le credenziali di accesso con il tuo Identity Provider.",
      listitem2_1:
        "Accedi a IO dal web, utilizzando le tue credenziali SPID o CIE.",
  ...
  email: {
    cduScreens: {
      validateMail: {
        ...
        subtitle:
          "Per continuare a usare l’app, devi confermare che la tua email è",
      ...
      emailAlreadyTaken: {
        ...
        subtitleEnd:
          "è già in uso su IO, devi inserirne uno diverso per continuare a usare l’app.",
    ...
    insert: {
      ...
      alertDescription:
        "Può succedere se condividi lo stesso indirizzo con un familiare",
    ...
    newinsert: {
      ...
      subtitle:
        "Servirà a inviarti comunicazioni come ricevute di pagamento o messaggi di assistenza.",
      label: "Indirizzo email personale",
      alert: {
    ...
    newvalidate: {
      ...
      subtitle:
        "Per confermare il tuo indirizzo, segui le istruzioni che abbiamo inviato a",
      link: "Non è corretto?",
  ...
  onboarding: {
    ...
    tos: {
      ...
      error:
        "Non siamo riusciti a caricare l’Informativa privacy e i Termini e condizioni",
      alert: {
        title: "Attenzione",
        message:
    ...
    pin: {
      ...
      subTitle:
        "È il codice a 6 cifre per accedere a IO e autorizzare alcune operazioni in app.",
      ...
      errors: {
        invalid: {
          title: "Troppo facile!",
          description:
            "Scegli un codice difficile da indovinare, che non contenga un unico numero ripetuto (es. 000000)o un elenco di numeri ordinati (es. 123456 o 654321).",
      ...
      policy: {
        ...
        description:
          "Il codice di sblocco è composto da 6 cifre e ti servirà per accedere a IO e autorizzare alcune operazioni in app.",
        bulletListTitle:
          "Scegli un codice difficile da indovinare e che non contenga:",
    ...
    biometric: {
      ...
      available: {
        ...
        settings:
          "Puoi modificare la tua scelta in ogni momento da Impostazioni > Sicurezza",
        body: {
          ...
          infoStart:
            "Potrai usare il riconoscimento biometrico al posto del codice di sblocco. Ti permetterà di accedere all’app e autorizzare operazioni e pagamenti, con il tuo",
      ...
      unavailable: {
        ...
        subtitle:
          "IO ti invia comunicazioni che ti riguardano personalmente. Assicurati che solo tu possa accedere all’app impostando un codice o un segno per sbloccare il dispositivo.",
        body: {
          label: "Come fare",
          step1: {
            label: "Step 1",
    ...
    notifications: {
      ...
      preview: {
        ...
        reminderOnPreviewOnMessage:
          "Entra nell’app e paga l’avviso emesso da ACI",
  ...
  payment: {
    ...
    alertNoActivePaymentMethods: {
      ...
      message:
        "Abilita almeno un metodo presente nel tuo Portafoglio, o aggiungine uno nuovo.",
      buttons: {
  ...
  wallet: {
    ...
    favourite: {
      ...
      setFavoriteSubtitle:
        "Quando paghi in app, IO mostra in automatico questo metodo di pagamento"
    },
    incoming: {
      title: "In arrivo",
      message:
    ...
    searchAbi: {
      ...
      bancomat: {
        ...
        description: {
          text1:
            "Aggiungendo PagoBANCOMAT al tuo Portafoglio, potrai aderire alle iniziative disponibili su IO.\nProseguendo accetti l'",
      ...
      bpay: {
        ...
        description: {
          text1:
            "Abbina BANCOMAT Pay per pagare più facilmente gli avvisi pagoPA e aderire alle iniziative disponibili su IO.\nProseguendo accetti l'",
          text2: "informativa sul trattamento dei dati personali.",
          text3:
            "Premi su “Continua” per cercare gli account a te intestati. In alternativa, cerca la banca su cui hai un account BANCOMAT Pay attivo ",
      ...
      cobadge: {
        ...
        description: {
          text1:
            "Aggiungendo al tuo Portafoglio tutte le carte Maestro, Mastercard, V-Pay e Visa a te associate, potrai aderire alle iniziative disponibili su IO.",
    ...
    accessibility: {
      ...
      folded: {
        creditCard:
          "Carta {{brand}}, il numero della carta finisce con {{blurredNumber}}",
    ...
    onboarding: {
      paymentMethodsList: {
        header: {
          ...
          subtitle:
            "Il metodo verrà memorizzato e potrà essere utilizzato per effettuare pagamenti in app o aderire a iniziative compatibili."
        }
      },
      bancomat: {
        ...
        add: {
          ...
          blocked:
            "Questa carta risulta bloccata e pertanto non può essere attivata per aderire alle iniziative disponibili su IO. Contatta la tua banca."
        }
      },
      bPay: {
        headerTitle: "Aggiungi BANCOMAT Pay",
        loadingSearch:
          "Stiamo recuperando i tuoi dati BANCOMAT Pay\n\nAttendi qualche secondo",
        add: {
          label: "Account BANCOMAT Pay {{current}} di {{length}}",
          screenTitle: "Vuoi aggiungere questo account?"
        },
        loadingAdd:
          "Stiamo aggiungendo il tuo account BANCOMAT Pay\n\nAttendi qualche secondo",
        koTimeout: {
      ...
      paypal: {
        ...
        selectPsp: {
          ...
          infoBottomSheet: {
            ...
            row2Description1:
              "Quando paghi un avviso, potrà applicare un costo massimo fino a ",
            row2Description2: ". Vedrai l'importo esatto prima della conferma.",
            row3Description1:
              "Si applicano i Termini e condizioni d’uso e l’Informativa Privacy di {{psp}}"
          },
      ...
      coBadge: {
        ...
        start: {
          loading:
            "Stiamo caricando le impostazioni\n\nAttendi qualche secondo",
          koDisabled: {
        ...
        search: {
          ...
          koNotFound: {
            title:
              "Non abbiamo trovato nessuna carta tra le banche aderenti al servizio",
        ...
        add: {
          ...
          blocked:
            "Questa carta risulta bloccata e pertanto non può essere attivata per aderire alle iniziative disponibili su IO. Contatta la tua banca.",
          warning1:
            "In alcuni casi, i dati mostrati potrebbero essere diversi da quelli riportati sulla carta fisica: ",
          warning2: "se hai dubbi contatta la tua banca.",
          loading:
            "Stiamo aggiungendo la tua carta con circuito internazionale\n\nAttendi qualche secondo..."
        },
        chooseType: {
          title: "La tua carta ti permette di acquistare online?",
          description:
            "Questa domanda ci permette di capire meglio com’è fatta la tua carta e aiutarti ad aggiungerla al tuo Portafoglio.",
          path: {
            enabled: {
              title: "Sì, è abilitata agli acquisti online",
              description:
                "Verificheremo i dati della carta con la tua banca, di solito via sms o notifica push"
            },
            disabled: {
              title: "No, la uso solo nei negozi",
              description:
                "Cercheremo tutte le carte intestate a te presso le banche aderenti al servizio"
            },
            unknown: {
              title: "Non lo so",
              description:
      ...
      generalError:
        "C'è stato un errore generico durante l'aggiunta del metodo di pagamento",
      outcome: {
        SUCCESS: {
    ...
    alert: {
      ...
      favorite:
        "Per modificare quest'opzione, seleziona un altro metodo dal tuo Portafoglio e impostalo come preferito.",
    ...
    saveCard: {
      ...
      subtitle:
        "Aggiungendo la carta al tuo Portafoglio, potrai effettuare pagamenti in app e aderire alle iniziative disponibili su IO.",
      infoTitle: "Usa come metodo preferito",
      info: "Quando paghi in app, IO ti mostra in automatico questo metodo di pagamento",
      notice:
        "Per verificare la tua carta, tratteniamo temporaneamente € 0,02. Non preoccuparti: ti restituiremo l'importo al più presto.",
      temporaryError:
    ...
    challenge3ds: {
      ...
      description:
        "L’emittente della carta ha bisogno della tua conferma. Se riscontri problemi, contatta la tua banca."
    },
    saveCardInPayment: {
    ...
    pickPsp: {
      ...
      info2Bold:
        "compatibili con il tuo metodo, anche se non sei loro cliente.",
      provider: "Gestore",
    ...
    payWith: {
      ...
      contextualHelpContent:
        "**Qui puoi scegliere il metodo con cui procedere al pagamento.** IO supporta al momento solo pagamenti con carta di credito/debito ma presto saranno aggiunti altri metodi di pagamento come PayPal e altri.\n",
      pickPaymentMethod: {
        ...
        notAvailable: {
          ...
          arriving: {
            ...
            bottomSheetDescription:
              "Nel frattempo, prova a pagare con un altro metodo. Puoi utilizzare pagoPA anche sulla tua app di pagamenti preferita o sul sito del tuo Ente Creditore."
          },
          unaccepted: {
            bottomSheetTitle: "Perché non posso pagare con questa carta?",
            bottomSheetDescription:
              "Il circuito di questa carta consente di pagare nei punti vendita fisici, ma non online. Se la tua carta è abilitata ai pagamenti online, aggiungila al tuo Portafoglio come 'carta di debito o di credito'."
          },
          payment_disabled: {
    ...
    firstTransactionSummary: {
      ...
      amountInfo: {
        ...
        message:
          "Quando l'importo cambia, significa che l'ente creditore l'ha aggiornato automaticamente. In questo modo, hai sempre la certezza di pagare l’importo dovuto. Se è più alto, potrebbero esserci interessi, sanzioni o costi di notifica.\n\nPer ulteriori dettagli contatta l'ente creditore, poiché pagoPA non conosce i motivi dell'aggiornamento.",
        cta: "Ok, va bene"
      },
    ...
    methods: {
      ...
      card: {
        ...
        pagoPaCapability: {
          ...
          bottomSheetBody:
            "Questo metodo non è abilitato a effettuare pagamenti online.",
    ...
    dummyCard: {
      ...
      accessibility: {
        ...
        pan: {
          base: "Numero carta",
          error:
            "Numero carta. Per favore, inserisci almeno {{minLength}} cifre"
        },
        expirationDate: {
          base: "Data di scadenza, due cifre per il mese, due per l’anno",
          error:
            "Data di scadenza, due cifre per il mese, due per l’anno. Per favore, inserisci una data valida"
        },
        securityCode: {
          "3D": {
    ...
    QRtoPay: {
      ...
      cameraUsageInfo:
        "Inquadra il codice QR che trovi nell'avviso, oppure inserisci manualmente i dati (Codice Avviso e Codice Fiscale Ente Creditore).",
      setManually: "Inserisci manualmente",
      enroll_cta:
        "Per inquadrare il codice QR presente sull'avviso, devi prima consentire ad IO l'uso della fotocamera. Puoi farlo dal menu 'Impostazioni' del tuo dispositivo.",
      ...
      settingsAlert: {
        ...
        message:
          "IO ha bisogno di accedere alla tua galleria per salvare bonus e certificati, o caricare screenshot e avvisi di pagamento",
        buttonText: {
    ...
    outcomeMessage: {
      ...
      code3: {
        ...
        description:
          "Elimina la carta dal tuo Portafoglio e prova ad aggiungerla di nuovo. Assicurati che i dati inseriti siano riportati esattamente come sulla carta."
      },
      code4: {
        title: "Controlla la tua email",
        description:
          "Non è stato possibile verificare l’esito del pagamento. Se è andato a buon fine, riceverai a breve un’email con la ricevuta. Se non ricevi l’email, contatta l’Assistenza."
      },
      code7: {
      ...
      code10: {
        title: "Autorizzazione negata",
        description:
          "Probabilmente hai superato il massimale del tuo metodo. Verifica con la tua banca prima di riprovare."
      },
      code15: {
    ...
    payment: {
      ...
      failure: {
        ...
        PSP_PAYMENT_METHOD_NOT_AVAILABLE_ERROR: {
          ...
          subtitle:
            "Può succedere quando l’importo da pagare è particolarmente elevato, o se stai cercando di pagare una marca da bollo digitale.",
  ...
  cardComponent: {
    ...
    deleteMsg:
      "Rimuoveremo il metodo dal Portafoglio. Le eventuali iniziative a cui è collegato si disattiveranno entro 24 ore.",
  ...
  messages: {
    accessibility: {
      message: {
        ...
        archived: "Archiviato",
        description:
          "{{newMessage}} {{selected}}, ricevuto da {{organizationName}}, {{serviceName}}. {{subject}}. {{receivedAt}}. {{state}}",
    ...
    cta: {
      ...
      calendarPermDenied: {
        ...
        description:
          "Non abbiamo accesso al tuo calendario. Abilita i permessi per continuare.",
    ...
    archive: {
      emptyMessage: {
        ...
        subtitle:
          "Tieni premuto su un messaggio per spostarlo in archivio. I messaggi archiviati verranno conservati e saranno disponibili nei risultati di ricerca."
      }
    },
    inbox: {
      emptyMessage: {
        ...
        subtitle:
          "Quando un ente ti invierà una comunicazione la visualizzerai qui."
      }
    },
    operations: {
      archive: {
  ...
  messageDetails: {
    ...
    attachments: {
      ...
      badFormat:
        "Il formato dell'allegato non è supportato. Contatta l'ente mittente",
      corruptedFile:
        "L'allegato è danneggato e non può essere aperto. Contatta l'ente mittente",
      downloadFailed:
        "L'allegato non è al momento disponibile. Riprova o contatta l'ente mittente",
      showPreview: "Visualizza anteprima",
      failing: {
        details:
          "Non sono riuscito a scaricare l’allegato. Riprova o apri una segnalazione"
      }
    },
    banner: {
      ...
      content3:
        "il suo contenuto potrebbe cambiare nel tempo per darti informazioni sempre aggiornate.",
      action: "Scopri di più"
    },
    bottomSheet: {
      ...
      bodyPt3:
        ". In questo modo, le informazioni che contiene saranno sempre corrette.\n\nUn ente può modificare le informazioni di un messaggio dinamico solo ",
      bodyPt4: "in casi specifici",
      bodyPt5:
        ", per esempio per cambiare un'informazione vecchia o aggiornare un allegato non più valido.\n\nSe deve comunicarti nuove informazioni o aggiornamenti importanti, ti invierà un nuovo messaggio."
    },
    footer: {
  ...
  messagePDFPreview: {
    ...
    savedAtLocation:
      "Il documento {{name}} è stato salvato nella cartella Download.",
    share: "Condividi",
    ...
    errors: {
      ...
      opening:
        "Si è verificato un errore aprendo il documento. Potresti non avere installata l'applicazione per i PDF.",
  ...
  notifications: {
    profileBanner: {
      title:
        "Attiva le notifiche push per sapere quando ricevi un messaggio su IO.",
    ...
    modal: {
      content:
        "Attiva le notifiche push per sapere subito quando ricevi un nuovo messaggio in app.",
  ...
  send_email_messages: {
    ...
    switch: {
      ...
      subtitle:
        "Riceverai un'anteprima del messaggio al tuo indirizzo email, se il servizio lo consente."
    }
  },
  services: {
    optIn: {
      preferences: {
        ...
        banner:
          "Puoi modificare la tua scelta in ogni momento da Impostazioni > Preferenze",
        ...
        quickConfig: {
          ...
          body: {
            text1:
              "Ti contatteranno solo gli enti che hanno qualcosa di importante da dirti.",
            text2:
              "Potrai sempre disattivare le comunicazioni dei servizi che non ti interessano."
          }
        },
        manualConfig: {
          ...
          body: {
            text1:
              "Nessuno potrà contattarti. Per ricevere messaggi dovrai attivare i servizi uno a uno."
          },
          bottomSheet: {
  ...
  identification: {
    ...
    logoutDescription:
      "Puoi accedere con le tue credenziali SPID o CIE. Questa sessione verrà disconnessa.",
    logoutDescriptionProfileName:
      "Puoi accedere con le tue credenziali SPID o CIE. La sessione di {{profileName}} verrà disconnessa.",
    biometric: {
  ...
  msgErrorUpdateApp:
    "Si è verificato un errore durante l'apertura dello store delle app",
  messageUpdateApp:
    "IO introduce spesso piccole migliorie e nuove funzioni: per continuare a usare l'app è necessario aggiornarla all'ultima versione.",
  ...
  bottomSheets: {
    ciePin: {
      ...
      content:
        "Il codice PIN è composto da 8 cifre. Ti è stato comunicato in due momenti:\n\n• le prime 4 cifre le hai ricevute dall'anagrafe;  \n• le ultime 4 cifre le hai ricevute a casa con la CIE.\n  \nMettile insieme e inseriscile in quest’ordine."
    }
  },
  faq: {
    "1": {
  ...
  bonus: {
    ...
    state: {
      completed: {
        caption: "concluso",
        description:
          "Questa iniziativa è terminata e non è più possibile richiederla"
      }
    },
    bonusVacanze: {
      multipleBonus:
    ...
    cgn: {
      generic: {
        linkError:
          "In questo momento, il sito dell'operatore non è raggiungibile. Riprova più tardi."
      },
      accessibility: {
      ...
      merchantSearch: {
        ...
        emptyList: {
          shortQuery: {
            titleWithCount:
              "Cerca tra {{merchantCount}} partner aderenti a Carta Giovani Nazionale",
            titleWithoutCount:
              "Cerca tra i partner aderenti a Carta Giovani Nazionale"
          },
          noResults: {
      ...
      merchantsList: {
        ...
        categoriesList: {
          ...
          bottomSheet: {
            ...
            content:
              "Per agevolare la ricerca e migliorare la tua esperienza, abbiamo organizzato le categorie in base alla frequenza di utilizzo. Questa informazione non è legata al tuo profilo, ma si basa su dati complessivi di tutti gli utenti che utilizzano Carta Giovani Nazionale e hanno acconsentito al trattamento dei dati."
          }
        },
        filter: {
      ...
      detail: {
        ...
        status: {
          ...
          eycaPending:
            "Stiamo associando la tua Carta Giovani Nazionale a un Numero EYCA.",
      ...
      activation: {
        ...
        error: {
          title:
            "Il servizio Carta Giovani Nazionale in questo momento non è disponibile.",
          body: "Ci dispiace, riprova più tardi."
        },
        ineligible: {
          title:
            "Purtroppo non hai i requisiti per attivare la Carta Giovani Nazionale.",
        ...
        deactivate: {
          ...
          alert: {
            ...
            message:
              "La Carta verrà disattivata e non potrai più accedere alle opportunità disponibili."
          },
      ...
      otp: {
        error:
          "Per un problema tecnico non siamo riusciti a generare un codice sconto. Ti chiediamo di riprovare.",
        code: {
    ...
    cdc: {
      serviceEntryPoint: {
        notAvailable:
          "Il servizio non è disponibile in questo momento. Riprova più tardi."
      }
    }
  },
  features: {
    ...
    fci: {
      errors: {
        ...
        waitForQtsp: {
          ...
          subTitle:
            "Riceverai un messaggio con i documenti firmati non appena saranno pronti."
        },
        signed: {
          title: "Hai già firmato questi documenti",
          subTitle:
            "Puoi visualizzarli e scaricarli dal messaggio intitolato “Documenti firmati”."
        },
        unsupportedDevice: {
        ...
        generic: {
          default: {
            title: "C’è un problema sui nostri sistemi",
            subTitle:
              "Riprova tra qualche minuto. Se si ripete, contatta l’assistenza."
          },
          update: {
            title: "Aggiorna l’app",
            subTitle:
              "Verifica di avere installato l’ultima versione di IO e accedi di nuovo con SPID o CIE."
          },
          rejected: {
            title: "La firma non è andata a buon fine",
            subTitle:
              "L’ente ti contatterà nei prossimi giorni per farti firmare di nuovo. Se non dovesse succedere, scrivi a"
          },
          signing: {
            title: "La firma non è andata a buon fine",
            subTitle:
              "A causa di un problema tecnico, la firma non è andata a buon fine. Se il problema si ripete, contatta l’assistenza."
          },
          wrongUser: {
            title: "Non puoi firmare questi documenti",
            subTitle:
              "La richiesta di firma non è associata al tuo Codice Fiscale."
          },
          cancelled: {
      ...
      checkService: {
        ...
        content:
          "Per ricevere i documenti firmati devi attivare l’opzione che consente al servizio di inviarti messaggi. Se non la attivi, puoi completare la firma ma non riceverai i documenti firmati.",
        cancel: "Non ora",
        confirm: "Attiva"
      },
      noFields: {
      ...
      shareDataScreen: {
        ...
        content:
          "Consentiranno al fornitore della firma digitale di offrirti il servizio e di certificare la tua firma.",
        cancel: "Annulla",
        confirm: "Ok, va bene",
      ...
      qtspTos: {
        ...
        subTitle:
          "Per firmare, devi accettare i termini e condizioni del servizio e confermare di avere letto l’informativa privacy del fornitore della firma.",
        show: "Visualizza"
      },
      documents: {
        footer: {
      ...
      signatureFieldInfo: {
        ...
        subTitle:
          "Sono delle clausole che segnalano condizioni particolari a cui prestare attenzione e che devono essere accettate. Devono inoltre essere, per legge, facilmente identificabili per far sì che chi firma sia informato del loro contenuto prima di apporre la firma."
      }
    },
    wallet: {
      home: {
      ...
      transactions: {
        ...
        receipt: {
          ...
          hideBanner: {
            ...
            content:
              "L’operazione è irreversibile. La ricevuta non verrà più mostrata nell’elenco delle tue ricevute.",
            accept: "Sì, nascondi"
          }
        },
        details: {
      ...
      details: {
        payPal: {
          banner: {
            ...
            content:
              'Non usare questo metodo. Durante il pagamento, seleziona "PayPal (anche in 3 rate)".'
          }
        },
        pspAlert: {
          description:
      ...
      presentation: {
        ...
        credentialDetails: {
          ...
          fiscalCode: {
            ...
            action:
              "Premi per ingrandire e visualizzare il codice a barre a tutto schermo"
          },
          status: {
            valid: "Valida",
            invalid: "Non valida",
  ...
  support: {
    ...
    helpCenter: {
      ...
      supportComponent: {
        ...
        subtitle:
          "Dai un’occhiata alle FAQ: se non trovi la risposta che cerchi, apri una richiesta. Se hai già aperto una richiesta e vuoi verificarne lo stato o aggiungere dettagli, seleziona “Richieste in corso”.",
        adviceMessage:
          "Se il tuo problema riguarda il contenuto di un messaggio o il servizio di un ente, contatta quest’ultimo: trovi i riferimenti nel messaggio o nella scheda del servizio."
      }
    },
    panicMode: {
    ...
    askPermissions: {
      ...
      appVersionsHistoryValue:
        "Per capire se il problema dipende dall’ultimo aggiornamento",
      identityProvider: "Identity Provider",
      navigationData: "Dati di navigazione in app IO",
      navigationDataValue:
        "Come ad esempio l’ultima schermata o messaggio visualizzato in app IO",
      ...
      listBody:
        "Per caricare le tue richieste in corso, abbiamo bisogno di accedere ad alcuni tuoi dati.",
      ...
      toast: {
        emailClientNotFound:
          "Per ricevere assistenza scrivici a: {{emailAddress}}"
      }
    },
    chooseCategory: {
      header: "Apri una richiesta",
      ...
      subTitle: {
        category:
          "Aiutaci a capire meglio come possiamo aiutarti selezionando l’argomento del tuo problema: ti risponderemo il prima possibile, in orario lavorativo."
      }
    }
  },
  idpay: {
    ...
    initiative: {
      ...
      cie: {
        bottomSheet: {
          ...
          featureThree:
            "Se dimentichi il codice, puoi generarne un altro in ogni momento da Impostazioni > Sicurezza."
        }
      }
    },
    onboarding: {
  ...
  unsupportedDevice: {
    warning:
      "A breve il tuo dispositivo potrebbe non essere più compatibile con l’app IO.",
    title: "Questo dispositivo non è più compatibile con IO",
    subtitle:
      "Assicurati che il sistema operativo sia aggiornato all’ultima versione. Se è già così, per continuare a usare IO devi accedere da un altro dispositivo.",
    cta: {
      faq: "Come mai?"
    }
  },
  fastLogin: {
    ...
    userInteraction: {
      sessionExpired: {
        noPin: {
          title: "È passato troppo tempo!",
          subtitle:
            "Per motivi di sicurezza, devi identificarti di nuovo con SPID o CIE. Potrai poi riprendere la configurazione di IO da dove l’avevi interrotta.",
    ...
    whatsNew: {
      ...
      subtitle:
        "Ora puoi accedere all'app utilizzando il tuo SPID o la tua CIE solo una volta all'anno. Ti basterà poi utilizzare il tuo codice di sblocco o il biometrico per entrare."
    }
  },
  whatsNew: {
    title: "Cosa cambia?"
