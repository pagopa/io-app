...
declare -a apis=(
  ...
  "./definitions/pagopa/walletv3 https://raw.githubusercontent.com/pagopa/pagopa-infra/v1.724.0/src/domains/pay-wallet-app/api/io-payment-wallet/v1/_openapi.json.tpl"
  "./definitions/pagopa/ecommerce https://raw.githubusercontent.com/pagopa/pagopa-infra/v1.724.0/src/domains/ecommerce-app/api/ecommerce-io/v2/_openapi.json.tpl"
  ...
  "./definitions/pn/aar https://raw.githubusercontent.com/pagopa/io-messages/send-func@1.3.6/apps/send-func/openapi/aar-notification.yaml"
  # FCI APIs
