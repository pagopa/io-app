...
declare -a apis=(
  ...
  # IDPay APIs
  "./definitions/idpay https://raw.githubusercontent.com/pagopa/cstar-securehub-infra-api-spec/refs/tags/v2.44.2/src/idpay/apim/api/idpay_appio_full/openapi.appio.full.yml"
  # Services APIs
  ...
  "./definitions/pn/aar https://raw.githubusercontent.com/pagopa/io-messages/ed902158c99345dde8e1a37c78252d360e6d6c34/apps/send-func/openapi/aar-notification.yaml"
  # FCI APIs
