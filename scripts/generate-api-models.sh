...
declare -a apis=(
  ...
  "./definitions/pn/aar https://raw.githubusercontent.com/pagopa/io-messages/102402c46494c609b59829561c2f8c50fdc3ab1a/apps/send-func/openapi/aar-notification.yaml"
  # FCI APIs
