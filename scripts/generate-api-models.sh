...
declare -a apis=(
  ...
  # IDPay APIs
  "./definitions/idpay https://raw.githubusercontent.com/pagopa/cstar-securehub-infra-api-spec/d905f791b8d8e0aae7a382670c80d182e90d3da1/src/idpay/apim/api/idpay_appio_full/openapi.appio.full.yml"
  # Services APIs
