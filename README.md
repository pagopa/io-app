...
* `io-icon-font.ttf` contained in the directory fonts archive, to be placed in both [assets/fonts/io-icon-font/](assets/fonts/io-icon-font) and [android/app/src/main/assets/fonts].
