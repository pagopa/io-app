import { isHttpsLink } from "../../../components/ui/Markdown/handlers/link";
...
export function trackIOOpenedFromUniversalAppLink(link_id: string) {
  ...
  // internal link that should not be tracked as universal app link opening)
  if (isHttpsLink(link_id)) {
    void mixpanelTrack(
