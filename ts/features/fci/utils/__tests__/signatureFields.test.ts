...
describe("Test signatureFields utils", () => {
  describe("Test clausesByType", () => {
    ...
    it("it should returns an array with one item and clause type equal to REQUIRED", () => {
      expect(
    ...
    it("it should returns an array with two item and clause type equal to OPTIONAL", () => {
      expect(
