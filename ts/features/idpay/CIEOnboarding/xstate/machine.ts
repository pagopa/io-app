...
const createIDPayCIEOnboardingMachine = (isCodeEnabled: boolean) =>
  createMachine(
    {
...
type IDPayCIEOnboardingMachineType = ReturnType<
  typeof createIDPayCIEOnboardingMachine
>;
export type { IDPayCIEOnboardingMachineType };
export { createIDPayCIEOnboardingMachine };
