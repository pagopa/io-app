...
const isNextMultiPageAvailable = (context: Context) => {
  ...
  return requiredCriteria[context.multiConsents.length] !== undefined;
};
        ...
        DISPLAYING_REQUIRED_SELF_CRITERIA: {
          ...
          states: {
            ...
            ALL_CRITERIA_ACCEPTED: {
              type: "final"
              // target:'ACCEPTING_REQUIRED_CRITERIA' will be triggered by the onDone event
            }
          }
        },
