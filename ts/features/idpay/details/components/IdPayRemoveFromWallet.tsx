...
const IdPayRemoveFromWallet = (initiative: InitiativeDTO) => {
  ...
  const showAlert = () => {
    Alert.alert(
      "Vuoi eliminare Bonus Elettrodomestici dal Portafoglio?",
      "Il bonus verrà rimosso.",
      [
        {
          text:
            Platform.OS === "ios"
...
export default IdPayRemoveFromWallet;
