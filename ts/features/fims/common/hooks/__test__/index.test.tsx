...
import { useAutoFetchingServiceByIdPot, useFIMSFromServiceId } from "..";
...
describe("index", () => {
  ...
  describe("useFIMSFromServiceId", () => {
    ...
    it(`should call 'navigation.navigate' with proper paramters for unmatching service id service and return proper service data for analytics`, () => {
