...
import { createMigrate, MigrationManifest, PersistConfig, PersistedState, PersistPartial, persistReducer } from "redux-persist";
...
const migrations: MigrationManifest =  {
  ...
  "0": (state: PersistedState): PersistedLollipopState => {
    ...
    const castedPeviousState = state as unknown as PreviousPersistedLolliPoPState;
    return {
        ...castedPeviousState,
