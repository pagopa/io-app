...
export const TextFieldsShowroom = () => {
  ...
  */
  ...
  return (
    <BaseScreenComponent goBack={true} headerTitle={"Text fields"}>
          ...
          <View style={IOStyles.horizontalContentPadding}>
            ...
            <View>
              <LabelledItem
                ...
                accessibilityLabel={
                  "Accessibility label for PIN code text field"
                }
                inputProps={{
              ...
              >
                <LabelSmall weight="Regular" color="red">
                  When there are two lines, this custom description breaks
                  everything ¯\_(ツ)_/¯
                </LabelSmall>
              </View>
            </View>
