...
import { NoticeHeadingSection } from "../NoticeHeadingSection";
...
const renderComponent = (
  ...
  return renderScreenWithNavigationStoreContext(
    () => (
      <NoticeHeadingSection isLoading={isLoading} transaction={transaction} />
    ),
    PaymentsNoticeRoutes.PAYMENT_NOTICE_DETAILS,
    {},
    store
  );
};

describe("NoticeHeadingSection", () => {
