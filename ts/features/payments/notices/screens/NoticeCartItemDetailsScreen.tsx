...
export type PaymentsNoticeCartItemDetailsScreenParams = {
  cartItem: CartItem;
};

export type PaymentsNoticeCartItemDetailsScreenProps = RouteProp<
  PaymentsNoticeParamsList,
  "PAYMENT_NOTICE_CART_ITEM_DETAILS"
>;

const PaymentsNoticeCartItemDetailsScreen = () => {
  const route = useRoute<PaymentsNoticeCartItemDetailsScreenProps>();
...
export default PaymentsNoticeCartItemDetailsScreen;
