...
export type PaymentsTransactionBizEventsOperationDetailsScreenParams = {
  operationName: string;
  operationSubject: string;
  operationDetails: Dettaglio;
};

export type PaymentsTransactionBizEventsOperationDetailsScreenProps = RouteProp<
  PaymentsTransactionBizEventsParamsList,
  "PAYMENT_TRANSACTION_BIZ_EVENTS_OPERATION_DETAILS"
>;

const PaymentsTransactionBizEventsOperationDetailsScreen = () => {
  const route =
    useRoute<PaymentsTransactionBizEventsOperationDetailsScreenProps>();
...
export default PaymentsTransactionBizEventsOperationDetailsScreen;
