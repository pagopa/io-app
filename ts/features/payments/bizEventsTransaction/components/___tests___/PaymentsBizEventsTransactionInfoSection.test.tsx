...
import PaymentsBizEventsTransactionInfoSection from "../PaymentsBizEventsTransactionInfoSection";
...
describe("PaymentsBizEventsTransactionInfoSection", () => {
  it("renders loading skeletons when loading is true", () => {
    const { getAllByTestId } = render(
      <PaymentsBizEventsTransactionInfoSection loading={true} />
    );
  ...
  it("renders transaction information correctly when transaction data is provided", () => {
    const { getByText } = render(
      <PaymentsBizEventsTransactionInfoSection
  ...
  it("does not render sections if transaction data is missing", () => {
    const { queryByText } = render(
      <PaymentsBizEventsTransactionInfoSection loading={false} />
    );
    expect(
