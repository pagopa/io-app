...
import { trackLoginCieDataSharingError } from "../../../../../screens/authentication/analytics/cieAnalytics"; // TODO: separate cie analytics?
...
export const ItwCieConsentDataUsageScreen = () => {
  const route =
    useRoute<
      Route<
        typeof ITW_ROUTES.ISSUANCE.EID_CIE.CONSENT_DATA_USAGE,
