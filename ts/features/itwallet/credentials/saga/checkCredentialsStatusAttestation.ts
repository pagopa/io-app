...
import { CREDENTIALS_MAP, trackItwStatusCredentialAttestationFailure } from "../../analytics";
...
export function* updateCredentialStatusAttestationSaga(
  ...
  try {
    ...
    if (isIssuerResponseError(e, Codes.CredentialInvalidStatus)) {
      ...
      trackItwStatusCredentialAttestationFailure(CREDENTIALS_MAP[credential.credentialType]);
