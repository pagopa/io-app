...
/**
 * This actions stores one or multiple credentials using the CredentialMetadata
 * payload. Credentials are stored using the credential ID as key, the new
 * credential completely overwrites the previous one. It also accepts optional
 * callbacks in the meta to handle success and failure cases after the
