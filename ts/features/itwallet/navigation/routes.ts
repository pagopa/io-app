...
export const ITW_ROUTES = {
  ...
  L3_ONBOARDING: "ITW_CARD_L3_ONBOARDING" as const,
  L2_ONBOARDING: "ITW_CARD_L2_ONBOARDING" as const,
  LANDING: {
    DISCOVERY: "ITW_LANDING_SCREEN_DISCOVERY",
    CREDENTIAL_ISSUANCE: "ITW_LANDING_SCREEN_CREDENTIAL_ISSUANCE",
  ...
  ISSUANCE: {
    ...
    UPGRADE_CREDENTIALS: "ITW_ISSUANCE_UPGRADE_CREDENTIALS",
    CREDENTIAL_OFFER: {
      INTRO: "ITW_ISSUANCE_CREDENTIAL_OFFER_INTRO"
    }
  } as const,
  PRESENTATION: {
    ...
    CREDENTIAL_CARD_SCREEN: "ITW_PRESENTATION_CREDENTIAL_CARD_SCREEN",
