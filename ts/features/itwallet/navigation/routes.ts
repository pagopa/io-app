...
export const ITW_ROUTES = {
  ...
  IDENTIFICATION: {
    MODE_SELECTION: {
      L2: "ITW_IDENTIFICATION_MODE_SELECTION_L2",
      L3: "ITW_IDENTIFICATION_MODE_SELECTION_L3"
    },
    ...
    CIE: {
      PREPARATION_SCREEN: "ITW_IDENTIFICATION_CIE_PREPARATION_SCREEN",
      PREPARATION_ALT_SCREEN: "ITW_IDENTIFICATION_CIE_PREPARATION_ALT_SCREEN",
      PIN_PREPARATION_SCREEN: "ITW_IDENTIFICATION_CIE_PIN_PREPARATION_SCREEN",
      CAN_PREPARATION_SCREEN: "ITW_IDENTIFICATION_CIE_CAN_PREPARATION_SCREEN",
      PIN_SCREEN: "ITW_IDENTIFICATION_CIE_PIN_SCREEN",
      CARD_READER_SCREEN: {
        L3: "ITW_IDENTIFICATION_CIE_CARD_READER_SCREEN_L3",
        L2: "ITW_IDENTIFICATION_CIE_CARD_READER_SCREEN_L2"
      },
