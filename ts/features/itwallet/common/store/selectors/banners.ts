...
/**
 * Returns if the discovery banner should be displayed or not based on the
 * user's preferences. The banner should be visible only if the user closed it
...
/**
 * Returns whether the IT-wallet upgrade banner in MDL details is hidden.
 * Defaults to false.
 */
...
/**
 * Returns whether the IT-wallet discovery banner in wallet screen is hidden.
 * Defaults to false.
 */
