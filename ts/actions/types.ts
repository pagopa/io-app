...
import {Dispatch as DispatchAPI, MiddlewareAPI as ReduxMiddlewareAPI, Store as ReduxStore, StoreEnhancer as ReduxStoreEnhancer} from 'redux';
...
export type ApplicationStateAction = {
  type: typeof APP_STATE_CHANGE_ACTION; payload: ApplicationState;
};

export type Action = | ApplicationActions | ApplicationStateAction |
    NavigationAction | SessionActions | OnboardingActions | ProfileActions |
    ErrorActions
