...
export const PAYMENT_INSERT_DATA_MANUALLY: "PAYMENT_INSERT_DATA_MANUALLY" =
  "PAYMENT_INSERT_DATA_MANUALLY";
export const PAYMENT_SHOW_SUMMARY: "PAYMENT_SHOW_SUMMARY" =
...
export const COMPLETE_PAYMENT: "COMPLETE_PAYMENT" = "COMPLETE_PAYMENT";
export const STORE_RPTID_DATA: "STORE_RPTID_DATA" = "STORE_RPTID_DATA";
export const STORE_VERIFICA_DATA: "STORE_VERIFICA_DATA" = "STORE_VERIFICA_DATA";
export const STORE_INITIAL_AMOUNT: "STORE_INITIAL_AMOUNT" =
  "STORE_INITIAL_AMOUNT";
export const PAYMENT_CONFIRM_SUMMARY: "PAYMENT_CONFIRM_SUMMARY" =
  "PAYMENT_CONFIRM_SUMMARY";
export const PAYMENT_STORE_SELECTED_PAYMENT_METHOD: "PAYMENT_STORE_SELECTED_PAYMENT_METHOD" =
  "PAYMENT_STORE_SELECTED_PAYMENT_METHOD";
export const PAYMENT_REQUEST_OTP: "PAYMENT_REQUEST_OTP" = "PAYMENT_REQUEST_OTP";
export const PAYMENT_VERIFY_OTP: "PAYMENT_VERIFY_OTP" = "PAYMENT_VERIFY_OTP";
