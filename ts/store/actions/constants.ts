...
export const LOAD_LATEST_TRANSACTIONS_LIST: "LOAD_LATEST_TRANSACTIONS_LIST" =
  "LOAD_LATEST_TRANSACTIONS_LIST";
export const TRANSACTIONS_FETCHED: "TRANSACTIONS_FETCHED" = "TRANSACTIONS_FETCHED";
export const SELECT_CARD: "SELECT_CARD" = "SELECT_CARD";
export const LOAD_TRANSACTIONS_LIST_BY_SELECTED_CARD: "LOAD_TRANSACTIONS_LIST_BY_SELECTED_CARD" =
