 ...
 */
const CURRENT_REDUX_STORE_VERSION = 43;
...
const migrations: MigrationManifest = {
  ...
  "43": (state: PersistedState) => {
    ...
    // We cast is to a partial type to represent the legacy part
    // that we want to convert but the instance of 'state' containts
