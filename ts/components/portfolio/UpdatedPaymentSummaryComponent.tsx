...
export default class UpdatedPaymentSummaryComponent extends React.Component<Props>{
		...
		return(
			<Grid style={styles.darkContentPadding}>
								...
								<Row style={styles.toAlignCenter}>
										<H3 style={styles.white}>
											{I18n.t("portfolio.QRtoPay.updatedAmount")}
										</H3>
										<Text> {' '} </Text>
								...
								<Row style={styles.toAlignColumnstart}>
									<Text style={styles.white}> 
										{I18n.t("portfolio.QRtoPay.updateInfo")} 
									</Text>
									<Text style={styles.underlined}>
										{I18n.t("portfolio.QRtoPay.moreInfo")}
									</Text>
								</Row>
								<Row>
									<Text 
