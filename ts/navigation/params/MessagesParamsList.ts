...
import { PnAttachmentPreviewNavigationParams } from "../../features/pn/screens/PnAttachmentPreview";
...
export type MessagesParamsList = {
  ...
  [ROUTES.MESSAGE_DETAIL_ATTACHMENT]: PnAttachmentPreviewNavigationParams;
