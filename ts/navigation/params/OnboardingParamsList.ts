...
import { OnboardingServicesPreferenceScreenNavigationProps } from "../../screens/onboarding/OnboardingServicesPreferenceScreen";
import ROUTES from "../routes";

export type OnboardingParamsList = {
  [ROUTES.ONBOARDING_SHARE_DATA]: undefined;
  [ROUTES.ONBOARDING_SERVICES_PREFERENCE]: OnboardingServicesPreferenceScreenNavigationProps;
