...
export type AppParamsList = {
  ...
  [IDPayUnsubscriptionRoutes.IDPAY_UNSUBSCRIPTION_MAIN]:
    ...
    | IDPayUnsubscriptionNavigatorParams;
  [IDPayPaymentRoutes.IDPAY_PAYMENT_CODE_SCAN]: undefined; // FIXME: remove after react-navigation 6.x upgrade. This should be insde IDPAY_PAYMENT_MAIN
  ...
  [WalletPaymentRoutes.WALLET_PAYMENT_BARCODE_SCAN]: undefined; // FIXME: remove after react-navigation 6.x upgrade. This should be insde WALLET_PAYMENT_MAIN
};
