    ...
    return(
      <Content style={{backgroundColor: '#fff'}}>
        <Header style={{alignItems: 'center'}}>
          ...
          <Text style={{color: '#fff', fontSize: 20}}>DOMICILIO DIGITALE</Text>
          <Right>
            <Button transparent onPress={() => {}}>
        ...
        <Body style={{padding: 10}}>
          ...
          <Text style={{marginTop: 20}}>
            ...
            puoi usarlo per ricevere le comunicazioni
            ufficiali dalle pubblica amministrazioni
            abilitate.
          </Text>
          <Text style={{marginTop: 10}}>
            Non ti preoccupare! Dopo aver impostato il
            Domicilio Digitale, se lo vorrai potrai
