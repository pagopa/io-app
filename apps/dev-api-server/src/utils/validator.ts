...
/**
 * Check if the given payload is a right representation of the static type T if
 * it is not, an exception will be raised, otherwise an object of type T will be
 * returned
 */
