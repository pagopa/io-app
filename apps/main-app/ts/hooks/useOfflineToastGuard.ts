 ...
 * function. If any offline condition is met (no internet, unknown connectivity,
 ...
 * @returns A wrapped function that either executes the provided function or
 *   shows a toast error message and returns `undefined`.
 */
