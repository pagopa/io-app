import { IOSpacing, IOVisualCostants } from "@io-app/design-system";
 ...
 *
 * - `screenEndSafeArea`: the amount of safe area without additional margins. For
 *   devices that don't have safe area boundaries (e.g. iPhone with home button)
 *   it returns a fallback value that prevents content from sticking to the
 *   bottom.
 * - `screenEndMargin`: the total amount of space to add at the end of the
 *   ScrollView. It's a sum of the `screenSafeArea' value and the default
 *   `contentEndMargin' that should be applied at the end of each app screen.
 */
