...
- Before adding code to the `settings/**/shared` directory, carefully consider if it's truly specific to settings but needed _elsewhere_, or if it's generic enough to potentially belong in a top-level shared location later.
