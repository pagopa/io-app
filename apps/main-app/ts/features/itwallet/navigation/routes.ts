...
export const ITW_ROUTES = {
  ...
  ISSUANCE: {
    ...
    CREDENTIAL_OFFER_INTRO: "ITW_ISSUANCE_CREDENTIAL_OFFER_INTRO"
  } as const,
  PRESENTATION: {
    CONSENT_MANAGEMENT: "ITW_PRESENTATION_CONSENT_MANAGEMENT",
    CONSENT_MANAGEMENT_DETAIL: "ITW_PRESENTATION_CONSENT_MANAGEMENT_DETAIL",
    CONSENT_REVOCATION_SUCCESS: "ITW_PRESENTATION_CONSENT_REVOCATION_SUCCESS",
