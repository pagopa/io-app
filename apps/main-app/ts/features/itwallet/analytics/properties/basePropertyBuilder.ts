 ...
 * code). Ignores PID and historical L2 credentials, which are tracked by their
 ...
 * credentials catalogue/list. Ignores PID and historical L2 credentials, which
 * are tracked by their own dedicated properties.
 */
