 ...
 * the app wants to obtain, and whether a presented copy must be consumed
 * (deleted, decreasing the batch count) once a presentation that includes it
 * succeeds. These are typically one-time-use credentials.
 *
