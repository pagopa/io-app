import { Alert, Body, IOButton, VStack } from "@io-app/design-system";
...
/**
 * Shows an Alert if the environment is set to "pre", which informs the user
 * about the risks of using the test environment. The Alert contains a bottom
 * sheet with more information and a button to reset the environment.
 *
 * @returns The Alert component if the environment is set to "pre", otherwise
 *   null.
 */
