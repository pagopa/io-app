...
export type Context = {
  ...
  /**
   * The `keyTag`s of the credential copies actually included in the last
   * successfully sent Verifiable Presentation. Used to consume the
   * corresponding copy of any batch-issued credential (e.g. Proof of Age) once
