...
/**
 * Removes duplicates from an array of barcodes. It uses JSON.stringify to
 * compare the objects. This should work because IOBarcode is created every time
 * from the same decoder function, so data is always in the same order.
 *
