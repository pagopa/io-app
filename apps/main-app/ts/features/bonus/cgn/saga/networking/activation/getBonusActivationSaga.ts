 ...
 * - 409 -> Cannot activate the user's cgn because another updateCgn request was
 *   found for this user or it is already active.
 * - 403 -> Cannot activate a new CGN because the user is ineligible to get the
 *   CGN.
 *
