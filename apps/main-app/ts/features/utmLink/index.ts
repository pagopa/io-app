...
/**
 * This function is used to process the UTM tags from a link. We only process
 * three UTM tags: source, medium and campaign. Only the source and medium tags
 * are mandatory. Without them, the event is not tracked.
 *
 * Example:
 *
 ...
 *
 * @param url Universal/app link with `utm_source` (mandatory), `utm_medium`
 *   (mandatory) and `utm_campaign` (optional) parameters
 */
