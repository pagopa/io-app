...
/**
 * This function is used to track the tap on a link with UTM tags. We only
 * process three UTM tags: source, medium and campaign. Only the source and
 * medium tags are mandatory. Without them, the event is not tracked.
 *
 * Example:
 *
