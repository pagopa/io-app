...
declare -a apis=(
  ...
  # IDPay APIs
  "./definitions/idpay https://raw.githubusercontent.com/pagopa/cstar-securehub-infra-api-spec/3422e805b906e893769d2446ef1c56d1612177e4/src/idpay/apim/api/idpay_appio_full/openapi.appio.full.yml"
  # Services APIs
