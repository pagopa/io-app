...
IO_SERVICES_METADATA_VERSION=1.1.6
...
declare -a apis=(
  ...
  "./generated/definitions/idpay https://raw.githubusercontent.com/pagopa/cstar-securehub-infra-api-spec/refs/heads/UPBE-682-isee-handle/src/idpay/apim/api/idpay_appio_full/openapi.appio.full.yml"
